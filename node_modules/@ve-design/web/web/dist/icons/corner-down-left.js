...
const corner_down_leftraw_namespaceObject = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" fill=\"none\" viewBox=\"0 0 24 24\"><path stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"1.5\" d=\"M20 4v1.4c0 3.36 0 5.04-.654 6.324a6 6 0 0 1-2.622 2.622C15.44 15 13.76 15 10.4 15H4m5 5-5-5 5-5\"/></svg>\n";
const cornerDownLeftIcon = {
    name: 'corner-down-left',
    svg: corner_down_leftraw_namespaceObject
};
defineVeIcon();
registerIcon(cornerDownLeftIcon);
