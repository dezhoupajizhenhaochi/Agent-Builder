import { css as external_lit_css, html as external_lit_html, nothing } from "lit";
import { property, query, state as decorators_js_state } from "lit/decorators.js";
...
import { defineCustomElement, VeElement } from "./78928.js";
...
const veMarkdownBaseTokens = external_lit_css`
  :host {
    /* ============================================
     * 1. Base scales (rem)
     * ============================================ */
    --md-font-base: 1rem; /* 16px when 1rem = 16px */
    --md-font-step: 0.125rem; /* 2px */
    --md-space-base: 0.5rem; /* 8px */
    --md-1px: 0.0625rem; /* 1px in rem，用于亚像素基线修正 */

    /* ============================================
     * 2. Line-height ratios (unitless，按视觉职责命名)
     * ============================================ */
    --md-lh-display: 1.5; /* h1: 22→33  h2: 20→30  h4-6: 16→24 */
    --md-lh-snug: calc(4 / 3); /* h3: 18→24 */
    --md-lh-body: 1.75; /* paragraph/bold/italic/list/quote/link: 16→28 */
    --md-lh-mono: calc(11 / 7); /* inline-code: 14→22 */
    --md-lh-table: calc(23 / 14); /* table-cell: 14→23 (Figma md-sm-*) */

    /* ============================================
     * 3. Derived font-sizes (rem)
     *    heading 每升一级 +1 step；code/caption 每降一级 -1 step
     * ============================================ */
    --md-fs-h1: calc(
      var(--md-font-base) + 3 * var(--md-font-step)
    ); /* 1.375rem = 22px */
    --md-fs-h2: calc(
      var(--md-font-base) + 2 * var(--md-font-step)
    ); /* 1.25rem  = 20px */
    --md-fs-h3: calc(
      var(--md-font-base) + 1 * var(--md-font-step)
    ); /* 1.125rem = 18px */
    --md-fs-h4: var(--md-font-base); /* 1rem = 16px */
    --md-fs-h5: var(--md-font-base); /* 1rem */
    --md-fs-h6: var(--md-font-base); /* 1rem */
    --md-fs-body: var(--md-font-base); /* 1rem */
    --md-fs-link: var(--md-font-base); /* 1rem */
    --md-fs-bold: var(--md-font-base); /* 1rem */
    --md-fs-italic: var(--md-font-base); /* 1rem (与 body 同字号) */
    --md-fs-code: calc(
      var(--md-font-base) - var(--md-font-step)
    ); /* 0.875rem = 14px */
    --md-fs-table: calc(
      var(--md-font-base) - var(--md-font-step)
    ); /* 0.875rem = 14px */
    ...
    /* ============================================
     * 4. Derived line-heights (rem)
     *    line-height = font-size × ratio (rem × unitless = rem)
     * ============================================ */
    --md-lh-h1: calc(
      var(--md-fs-h1) * var(--md-lh-display)
    ); /* 2.0625rem = 33px */
    --md-lh-h2: calc(
      var(--md-fs-h2) * var(--md-lh-display)
    ); /* 1.875rem  = 30px */
    --md-lh-h3: calc(var(--md-fs-h3) * var(--md-lh-snug)); /* 1.5rem = 24px */
    --md-lh-h4: calc(var(--md-fs-h4) * var(--md-lh-display)); /* 1.5rem */
    --md-lh-h5: calc(var(--md-fs-h5) * var(--md-lh-display)); /* 1.5rem */
    --md-lh-h6: calc(var(--md-fs-h6) * var(--md-lh-display)); /* 1.5rem */
    --md-lh-body-text: calc(
      var(--md-fs-body) * var(--md-lh-body)
    ); /* 1.75rem = 28px */
    --md-lh-bold: var(--md-lh-body-text); /* 1.75rem (与 body 同行高) */
    --md-lh-italic-text: var(--md-lh-body-text); /* 1.75rem */
    --md-lh-link: var(--md-lh-body-text); /* 1.75rem */
    --md-lh-list-text: var(--md-lh-body-text); /* 1.75rem */
    --md-lh-quote-text: var(--md-lh-body-text); /* 1.75rem */
    --md-lh-code-text: calc(
      var(--md-fs-code) * var(--md-lh-mono)
    ); /* 1.375rem = 22px */
    --md-lh-inline-code: calc(
      var(--md-font-base) * var(--md-lh-display)
    ); /* 1.5rem = 24px (行内代码对齐正文 24px 行高基准) */
    --md-lh-table-text: calc(
      var(--md-fs-table) * var(--md-lh-table)
    ); /* 1.4375rem = 23px */

    /* ============================================
     * 5. Derived padding-block (上下边距，rem)
     *    底部 pb 统一 = space-base (= 0.5rem) — markdown 阅读节奏单位
     *    顶部 pt 按级别派生 (含亚像素基线修正以对齐 Figma):
     *      h1   = 2  × base + 0.5px  (1.03125rem  = 16.5px)
     *      h2   = 2  × base - 1px    (0.9375rem   = 15px)
     *      h3   = 1.5 × base         (0.75rem     = 12px)
     *      h4-6 = 1   × base         (0.5rem      = 8px)
     *    separator py = 2 × base    (1rem = 16px)
     *    inline-code  pt/pb 对齐正文基线
     * ============================================ */
    --md-pb: var(--md-space-base); /* 0.5rem = 8px */

    --md-pt-h1: calc(
      var(--md-space-base) * 2 + 0.5 * var(--md-1px)
    ); /* 1.03125rem = 16.5px */
    --md-pt-h2: calc(
      var(--md-space-base) * 2 - var(--md-1px)
    ); /* 0.9375rem = 15px */
    --md-pt-h3: calc(var(--md-space-base) * 1.5); /* 0.75rem = 12px */
    --md-pt-h4: var(--md-space-base); /* 0.5rem = 8px */
    --md-pt-h5: var(--md-space-base);
    --md-pt-h6: var(--md-space-base);

    --md-pad-h1: var(--md-pt-h1) var(--md-pb); /* 1.03125rem 0.5rem */
    --md-pad-h2: var(--md-pt-h2) var(--md-pb);
    --md-pad-h3: var(--md-pt-h3) var(--md-pb);
    --md-pad-h4: var(--md-pt-h4) var(--md-pb);
    --md-pad-h5: var(--md-pt-h5) var(--md-pb);
    --md-pad-h6: var(--md-pt-h6) var(--md-pb);
    --md-pad-body: 0 var(--md-pb); /* 0 0.5rem */
    --md-pad-separator: calc(var(--md-space-base) * 2); /* 1rem = 16px */
    /* inline-code 垂直 padding：行内元素的背景填充由 content-box + padding +
     * border 决定，line-height 不参与绘制。0 padding 时灰底 ink box（含 0.5px
     * 边框）实测约 17.5px（1.09375rem），要让灰底填满 24px chip：
     *   padding = (24 - 17.5) / 2 = 3.25px */
    --md-pad-inline-code: calc(
      (var(--md-inline-code-h) - 1.09375rem) / 2
    ); /* 0.203125rem = 3.25px */

    /* ============================================
     * 6. Geometry — list marker / inline-code (rem)
     *    全部 base 倍数派生，radius/border 等几何也用 rem，
     *    保证整体随 font-size 缩放
     * ============================================ */
    --md-list-gap: var(--md-space-base); /* 0.5rem */
    --md-list-marker-w: calc(var(--md-font-base) * 1.6); /* 1rem = 16px */
    --md-list-bullet: calc(var(--md-space-base) * 0.5); /* 0.25rem = 4px */

    --md-inline-code-h: calc(
      var(--md-space-base) * 3
    ); /* 1.5rem = 24px (code chip 盒高) */
    --md-inline-code-radius: calc(
      var(--md-space-base) * 0.75
    ); /* 0.375rem = 6px */
    --md-inline-code-px: calc(var(--md-space-base) * 0.75); /* 0.375rem = 6px */

    /* footnote 引用圆形标记几何 */
    --md-footnote-ref-size: calc(
      var(--md-space-base) * 2
    ); /* 1rem = 16px 圆形直径 */

    /* Link 下划线（Figma: dotted，thickness 6.5%，offset 22.5%，均相对字号）
     * 用 em 表达，随 link 字号自动缩放 */
    --md-link-decoration-thickness: 0.065em; /* 6.5% → 1.04px @16px */
    --md-link-decoration-offset: 0.225em; /* 22.5% → 3.6px @16px */

    /* ============================================
     * 7. Table geometry (Figma 新版 Table 变体, rem)
     * ============================================ */
    --md-table-header-py: var(--md-space-base); /* 0.5rem = 8px */
    --md-table-cell-py: calc(var(--md-space-base) * 1.5); /* 0.75rem = 12px */
    --md-table-cell-px: calc(var(--md-space-base) * 2); /* 1rem = 16px */
    --md-table-text-max-w: calc(var(--md-space-base) * 40); /* 20rem = 320px */
  }

  /* size="small"：仅下调两个 base（字号 14px / 节奏 7px），其余字号、行高、
   * 间距、几何全部经 calc() 等比派生。需要更精细的缩放时，可直接覆盖
   * --md-font-base / --md-space-base。 */
  :host([size='small']) {
    --md-font-base: 0.875rem; /* 14px */
    --md-space-base: 0.4375rem; /* 7px */
  }
`;
const veMarkdownTokenDefaults = external_lit_css`
  :host {
    /* === Container ===
     * 默认不设最大宽度，由外部容器决定布局；如需限制可显式覆盖
     * --ve-markdown-max-width（例如 48.5rem）。
     */
    --ve-markdown-max-width: none;
    --ve-markdown-text-color: var(--color-text-primary, #1f1f23);
    --ve-markdown-muted-color: var(--color-text-tertiary, #7a7880);
    --ve-markdown-font-family: var(--font-cn);

    /* === Headings — sourced from md-base === */
    --ve-markdown-heading-color: var(--color-text-primary, #1f1f23);
    --ve-markdown-heading-weight: var(--font-weight-medium, 500);

    --ve-markdown-h1-font-size: var(--md-fs-h1);
    --ve-markdown-h2-font-size: var(--md-fs-h2);
    --ve-markdown-h3-font-size: var(--md-fs-h3);
    --ve-markdown-h4-font-size: var(--md-fs-h4);
    --ve-markdown-h5-font-size: var(--md-fs-h5);
    --ve-markdown-h6-font-size: var(--md-fs-h6);

    --ve-markdown-h1-line-height: var(--md-lh-h1);
    --ve-markdown-h2-line-height: var(--md-lh-h2);
    --ve-markdown-h3-line-height: var(--md-lh-h3);
    --ve-markdown-h4-line-height: var(--md-lh-h4);
    --ve-markdown-h5-line-height: var(--md-lh-h5);
    --ve-markdown-h6-line-height: var(--md-lh-h6);

    --ve-markdown-h1-padding-block: var(--md-pad-h1);
    --ve-markdown-h2-padding-block: var(--md-pad-h2);
    --ve-markdown-h3-padding-block: var(--md-pad-h3);
    --ve-markdown-h4-padding-block: var(--md-pad-h4);
    --ve-markdown-h5-padding-block: var(--md-pad-h5);
    --ve-markdown-h6-padding-block: var(--md-pad-h6);

    /* === Paragraph / Body / Inline emphasis ===
     * Figma 新版以 md/md-bold = 16/28 Medium、md/md-paragraph = 16/28 Regular
     * 为准：bold/italic/list/blockquote/link 行高统一 28px，与 paragraph 对齐。
     */
    --ve-markdown-body-font-size: var(--md-fs-body);
    --ve-markdown-body-line-height: var(--md-lh-body-text);
    --ve-markdown-body-weight-normal: var(--font-weight-normal, 400);
    --ve-markdown-body-weight-emphasis: var(--font-weight-medium, 500);
    --ve-markdown-paragraph-padding-block: var(--md-pad-body);

    --ve-markdown-bold-font-size: var(--md-fs-bold);
    --ve-markdown-bold-line-height: var(--md-lh-bold);

    --ve-markdown-italic-font-size: var(--md-fs-italic);
    --ve-markdown-italic-line-height: var(--md-lh-italic-text);

    /* === Blockquote === */
    --ve-markdown-blockquote-border-color: var(--color-border-default, #d2d1e0);
    --ve-markdown-blockquote-border-width: calc(
      var(--md-space-base) * 0.375
    ); /* 0.1875rem = 3px */
    --ve-markdown-blockquote-padding-inline: calc(
      var(--md-space-base) * 2
    ); /* 1rem = 16px */
    --ve-markdown-blockquote-padding-block: var(--md-pad-body);
    --ve-markdown-blockquote-line-height: var(--md-lh-quote-text);

    /* === Lists === */
    --ve-markdown-list-gap: var(--md-list-gap);
    --ve-markdown-list-padding-block: var(--md-pad-body);
    --ve-markdown-list-marker-color: var(--color-text-primary, #1f1f23);
    --ve-markdown-list-marker-width: var(--md-list-marker-w);
    --ve-markdown-list-bullet-size: var(--md-list-bullet);
    --ve-markdown-list-line-height: var(--md-lh-list-text);
    --ve-markdown-list-nested-gap: var(
      --ve-markdown-list-gap
    ); /* 嵌套列表与父级文本的间距，与 li+li 一致 */

    /* === Separator === */
    --ve-markdown-separator-color: var(--color-border-default, #d2d1e0);
    --ve-markdown-separator-thickness: var(--stroke-0_5, 0.5px);
    --ve-markdown-separator-padding-block: var(--md-pad-separator);

    /* === Link ===
     * 下划线虚线，颜色 = color/text/accent（与文字同色），
     * thickness 6.5% / offset 22.5%（Figma 参数，相对字号）
     */
    --ve-markdown-link-color: var(--color-text-accent, #1f1f23);
    --ve-markdown-link-hover-color: var(--color-border-interactive, #1f1f23);
    --ve-markdown-link-decoration-color: var(--color-text-accent, #1f1f23);
    --ve-markdown-link-decoration-thickness: var(
      --md-link-decoration-thickness
    );
    --ve-markdown-link-decoration-offset: var(--md-link-decoration-offset);
    --ve-markdown-link-font-size: var(--md-fs-link);
    --ve-markdown-link-line-height: var(--md-lh-link);

    /* === Inline code ===
     * Figma 新版: 加 0.5px subtle 边框、radius 6、padding-inline 6
     */
    --ve-markdown-inline-code-background: var(--color-bg-surface, #f6f6fc);
    --ve-markdown-inline-code-color: var(--color-text-primary, #1f1f23);
    --ve-markdown-inline-code-border-color: var(--color-border-subtle, #ebebf5);
    --ve-markdown-inline-code-border-width: var(--stroke-0_5, 0.5px);
    --ve-markdown-inline-code-radius: var(--md-inline-code-radius);
    --ve-markdown-inline-code-padding-inline: var(--md-inline-code-px);
    --ve-markdown-inline-code-padding-block: var(--md-pad-inline-code);
    --ve-markdown-inline-code-height: var(--md-inline-code-h);
    --ve-markdown-inline-code-font-family: var(--font-mono);
    --ve-markdown-inline-code-font-size: var(--md-fs-code);
    --ve-markdown-inline-code-line-height: var(--md-lh-inline-code);

    /* === Code block ===
     * 外层 bg = bg-base（与 table 保持一致）
     */
    --ve-markdown-code-block-background: var(--color-bg-base, #ffffff);
    --ve-markdown-code-block-border-color: var(--color-border-default, #d2d1e0);
    --ve-markdown-code-block-border-width: var(--stroke-0_5, 0.5px);
    --ve-markdown-code-block-radius: var(--radius-xl, 16px);
    /* 代码块长行处理：默认 pre（横向滚动，不换行）。设为 pre-wrap 可自动换行。 */
    --ve-markdown-code-block-white-space: pre;

    --ve-markdown-code-text-color: var(--color-text-primary, #1f1f23);
    --ve-markdown-code-font-family: var(--font-mono);
    --ve-markdown-code-font-size: var(--md-fs-code);
    --ve-markdown-code-line-height: var(--md-lh-code-text);

    --ve-markdown-code-header-background: var(--color-bg-secondary, #f6f6fc);
    --ve-markdown-code-header-color: var(--color-text-primary, #1f1f23);
    --ve-markdown-code-header-border-color: var(
      --color-border-default,
      #d2d1e0
    );
    --ve-markdown-code-header-border-width: var(--stroke-0_5, 0.5px);
    --ve-markdown-code-header-height: calc(
      var(--md-space-base) * 5
    ); /* 2.5rem = 40px */
    --ve-markdown-code-header-padding-inline: calc(
      var(--md-space-base) * 2
    ); /* 1rem = 16px */
    --ve-markdown-code-header-gap: var(--md-space-base); /* 0.5rem = 8px */
    --ve-markdown-code-label-color: var(--color-text-primary, #1f1f23);
    --ve-markdown-code-title-font-family: var(--font-en, inherit);
    --ve-markdown-code-title-font-size: var(--md-fs-code);
    --ve-markdown-code-title-line-height: var(--md-lh-code-text);

    --ve-markdown-code-body-padding-inline: calc(
      var(--md-space-base) * 2
    ); /* 1rem = 16px */
    --ve-markdown-code-body-padding-block: calc(var(--md-space-base) * 1.5)
      calc(var(--md-space-base) * 2); /* 0.75rem 1rem = 12px 16px */

    /* Copy button (icon-only action) */
    --ve-markdown-code-copy-color: var(--color-bg-icon, #383740);
    --ve-markdown-code-copy-hover-background: rgba(0, 0, 0, 0.06);
    --ve-markdown-code-copy-active-background: rgba(0, 0, 0, 0.1);
    --ve-markdown-code-copy-radius: var(--radius-md, 8px);
    --ve-markdown-code-scrollbar-color: rgba(0, 0, 0, 0.2);
    --ve-markdown-code-selection-background: var(--color-blue-200, #cfe0ff);

    /* highlight.js token palette (light scheme — github 风格) */
    --ve-markdown-code-token-text: var(--color-text-primary, #1f1f23);
    --ve-markdown-code-token-comment: #6a737d;
    --ve-markdown-code-token-keyword: #d73a49;
    --ve-markdown-code-token-string: #032f62;
    --ve-markdown-code-token-number: #005cc5;
    --ve-markdown-code-token-function: #6f42c1;
    --ve-markdown-code-token-variable: #e36209;
    --ve-markdown-code-token-attr: #22863a;
    --ve-markdown-code-token-property: #005cc5;
    --ve-markdown-code-token-link: #032f62;
    --ve-markdown-code-token-selector: #22863a;
    --ve-markdown-code-token-inserted: #22863a;
    --ve-markdown-code-token-deleted: #b31d28;

    /* === Table（样式已移入 ve-md-table 组件）=== */
    --ve-markdown-table-scrollbar-color: var(--color-border-default, #d2d1e0);
    --ve-markdown-radius-block: var(--radius-md, 8px);
    /* 单元格最大宽度：默认 none（不限制，长内容撑开表格横向滚动）。
     * 设为具体宽度（如 --md-table-text-max-w = 20rem）后，超长单元格会在
     * 该宽度处换行而非横向滚动。wrap 属性会切到 --md-table-text-max-w。 */
    --ve-markdown-table-cell-max-width: none;

    /* === Image === */
    --ve-markdown-image-width: 480px;
    --ve-markdown-image-radius: var(--radius-md, 8px);

    /* === Footnote ===
     * 行内引用与文末列表均使用灰色实心圆 + 弱化数字，二者复用同一套尺寸/配色。
     */
    --ve-markdown-footnote-ref-size: var(--md-footnote-ref-size);
    --ve-markdown-footnote-ref-background: var(--color-bg-secondary, #f6f6fc);
    --ve-markdown-footnote-ref-color: var(--color-text-tertiary, #7a7880);
    --ve-markdown-footnote-ref-hover-background: var(
      --color-bg-muted-surface,
      #ebebf5
    );
    --ve-markdown-footnote-ref-font-family: var(--font-en, inherit);
    --ve-markdown-footnote-ref-font-size: var(--md-fs-caption);
  }

  /* wrap：长内容自动换行而非横向滚动。
   * - 代码块切到 pre-wrap（配合 word-break: break-word 处理无空格长串）；
   * - 表格单元格限制最大宽度（--md-table-text-max-w = 20rem），超长内容在该
   *   宽度处换行，不再撑开表格触发横向滚动。
   * 需要更精细的控制时，可单独覆盖下面两个 token。 */
  :host([wrap]) {
    --ve-markdown-code-block-white-space: pre-wrap;
    --ve-markdown-table-cell-max-width: var(--md-table-text-max-w);
  }
`;
const style_token = [
    veMarkdownBaseTokens,
    veMarkdownTokenDefaults
];
const componentStyles = external_lit_css`
  :host {
    display: block;
    box-sizing: border-box;
    color: var(--ve-markdown-text-color);
    font-family: var(--ve-markdown-font-family);
    font-size: var(--ve-markdown-body-font-size);
    line-height: var(--ve-markdown-body-line-height);
    max-inline-size: var(--ve-markdown-max-width);
   ...
   * Headings
   * =========================================================== */
  .ve-markdown :where(h1, h2, h3, h4, h5, h6) {
    margin: 0;
    color: var(--ve-markdown-heading-color);
    font-weight: var(--ve-markdown-heading-weight);
    word-break: break-word;
  }

  .ve-markdown h1 {
    padding-block: var(--ve-markdown-h1-padding-block);
    font-size: var(--ve-markdown-h1-font-size);
    line-height: var(--ve-markdown-h1-line-height);
  }

  .ve-markdown h2 {
    padding-block: var(--ve-markdown-h2-padding-block);
    font-size: var(--ve-markdown-h2-font-size);
    line-height: var(--ve-markdown-h2-line-height);
  }

  .ve-markdown h3 {
    padding-block: var(--ve-markdown-h3-padding-block);
    font-size: var(--ve-markdown-h3-font-size);
    line-height: var(--ve-markdown-h3-line-height);
  }

  .ve-markdown h4 {
    padding-block: var(--ve-markdown-h4-padding-block);
    font-size: var(--ve-markdown-h4-font-size);
    line-height: var(--ve-markdown-h4-line-height);
  }

  .ve-markdown h5 {
    padding-block: var(--ve-markdown-h5-padding-block);
    font-size: var(--ve-markdown-h5-font-size);
    line-height: var(--ve-markdown-h5-line-height);
  }

  .ve-markdown h6 {
    padding-block: var(--ve-markdown-h6-padding-block);
    font-size: var(--ve-markdown-h6-font-size);
    line-height: var(--ve-markdown-h6-line-height);
  }
  ...
  .ve-markdown p {
    margin: 0;
    padding-block: var(--ve-markdown-paragraph-padding-block);
    font-size: var(--ve-markdown-body-font-size);
    line-height: var(--ve-markdown-body-line-height);
    font-weight: var(--ve-markdown-body-weight-normal);
    color: var(--ve-markdown-text-color);
    word-break: break-word;
  }
   ...
   * Inline emphasis
   * =========================================================== */
  .ve-markdown :where(strong, b) {
    font-style: normal;
    font-size: var(--ve-markdown-bold-font-size);
    line-height: var(--ve-markdown-bold-line-height);
    font-weight: var(--ve-markdown-body-weight-emphasis);
  }

  .ve-markdown :where(em, i) {
    font-style: italic;
    font-size: var(--ve-markdown-italic-font-size);
    line-height: var(--ve-markdown-italic-line-height);
    font-weight: var(--ve-markdown-body-weight-normal);
  }
   ...
   * Lists
   * =========================================================== */
  .ve-markdown :where(ul, ol) {
    margin: 0;
    padding-block: var(--ve-markdown-list-padding-block);
    padding-inline-start: var(--ve-markdown-list-marker-width);
    color: var(--ve-markdown-text-color);
  }

  .ve-markdown li {
    font-size: var(--ve-markdown-body-font-size);
    line-height: var(--ve-markdown-list-line-height);
    font-weight: var(--ve-markdown-body-weight-normal);
    word-break: break-word;
  }

  .ve-markdown li + li {
    margin-block-start: var(--ve-markdown-list-gap);
  }

  .ve-markdown li::marker {
    color: var(--ve-markdown-list-marker-color);
  }

  .ve-markdown :where(ul, ol) :where(ul, ol) {
    padding-block: 0;
  }
   ...
   * Blockquote
   * =========================================================== */
  .ve-markdown blockquote {
    display: flex;
    align-items: stretch;
    margin: 0;
    padding-block: var(--ve-markdown-blockquote-padding-block);
    padding-inline: 0;
    background: transparent;
  }

  .ve-markdown blockquote::before {
    content: '';
    flex: none;
    align-self: stretch;
    inline-size: var(--ve-markdown-blockquote-border-width);
    background: var(--ve-markdown-blockquote-border-color);
    border-radius: 0;
    margin-inline-end: var(--ve-markdown-blockquote-padding-inline);
  }

  .ve-markdown blockquote > * {
    color: var(--ve-markdown-text-color);
    font-size: var(--ve-markdown-body-font-size);
    line-height: var(--ve-markdown-blockquote-line-height);
    font-weight: var(--ve-markdown-body-weight-normal);
    word-break: break-word;
  }

  .ve-markdown blockquote > :first-child {
    padding-block-start: 0;
  }

  .ve-markdown blockquote > :last-child {
    padding-block-end: 0;
  }
  ...
  .ve-markdown hr {
    display: block;
    margin: var(--ve-markdown-separator-padding-block) 0;
    padding: 0;
    border: 0;
    block-size: var(--ve-markdown-separator-thickness);
    background: var(--ve-markdown-separator-color);
  }
   ...
   * =========================================================== */
  .ve-markdown a {
    color: var(--ve-markdown-link-color);
    font-size: var(--ve-markdown-link-font-size);
    line-height: var(--ve-markdown-link-line-height);
    font-family: var(--ve-markdown-font-family);
    text-decoration: underline;
    text-decoration-color: var(--ve-markdown-link-decoration-color);
    text-decoration-style: dotted;
    text-decoration-thickness: var(--ve-markdown-link-decoration-thickness);
    text-underline-offset: var(--ve-markdown-link-decoration-offset);
    word-break: break-word;
  }

  .ve-markdown a:hover {
    color: var(--ve-markdown-link-hover-color);
   ...
   * Inline code
   * =========================================================== */
  .ve-markdown :not(pre) > code {
    box-sizing: border-box;
    padding-block: var(--ve-markdown-inline-code-padding-block);
    padding-inline: var(--ve-markdown-inline-code-padding-inline);
    border: var(--ve-markdown-inline-code-border-width) solid
      var(--ve-markdown-inline-code-border-color);
    border-radius: var(--ve-markdown-inline-code-radius);
    background: var(--ve-markdown-inline-code-background);
    color: var(--ve-markdown-inline-code-color);
    font-family: var(--ve-markdown-inline-code-font-family);
    font-size: var(--ve-markdown-inline-code-font-size);
    line-height: var(--ve-markdown-inline-code-line-height);
  ...
  /* ===========================================================
   * Code block (fallback for raw <pre><code>; 主要由 ve-md-code-block 接管)
   * =========================================================== */
  .ve-markdown pre {
    margin: 0;
    padding-block: var(--ve-markdown-paragraph-padding-block);
  ...
  .ve-markdown pre code {
    display: block;
    box-sizing: border-box;
    inline-size: 100%;
    padding-inline: var(--ve-markdown-code-body-padding-inline);
    padding-block: var(--ve-markdown-code-body-padding-block);
    background: var(--ve-markdown-code-block-background);
    border: var(--ve-markdown-code-block-border-width) solid
      var(--ve-markdown-code-block-border-color);
    border-radius: var(--ve-markdown-code-block-radius);
    color: var(--ve-markdown-code-text-color);
    font-family: var(--ve-markdown-code-font-family);
    font-size: var(--ve-markdown-code-font-size);
    line-height: var(--ve-markdown-code-line-height);
    overflow: auto;
    white-space: pre;
  }

  /* ===========================================================
   * Table — 样式已完全移入 ve-md-table 组件，此处仅保留兜底
   * =========================================================== */
  .ve-markdown table {
    margin: 0;
  }
   ...
   * =========================================================== */
  .ve-markdown img {
    inline-size: var(--ve-markdown-image-width);
    max-inline-size: 100%;
    block-size: auto;
    border-radius: var(--ve-markdown-image-radius);
  }

  /* ===========================================================
   * Footnote — 行内引用与文末列表均使用灰色圆形数字标记
   * =========================================================== */
  /* 外层 a 占满整行行高，作为「与行内文字等高」的对齐盒，随行盒自然垂直居中；
   * 圆形背景由内部 __badge 以固定尺寸居中绘制，从而不依赖 transform 偏移。 */
  .ve-markdown .ve-md-footnote-ref {
    display: inline-flex;
    align-items: center;
    justify-content: center;
    box-sizing: border-box;
    block-size: var(--ve-markdown-body-line-height);
    margin-inline: 0.125em;
    vertical-align: top;
    text-decoration: none;
  }

  .ve-markdown .ve-md-footnote-ref__badge {
    display: inline-flex;
    align-items: center;
    justify-content: center;
    box-sizing: border-box;
    inline-size: var(--ve-markdown-footnote-ref-size);
    block-size: var(--ve-markdown-footnote-ref-size);
    border-radius: 50%;
    background: var(--ve-markdown-footnote-ref-background);
    color: var(--ve-markdown-footnote-ref-color);
    font-family: var(--ve-markdown-footnote-ref-font-family);
    font-size: var(--ve-markdown-footnote-ref-font-size);
    line-height: 1;
    font-weight: var(--ve-markdown-body-weight-normal);
    text-align: center;
  ...
  .ve-markdown .ve-md-footnote-ref:hover .ve-md-footnote-ref__badge {
    background: var(--ve-markdown-footnote-ref-hover-background);
  }

  .ve-markdown .ve-md-footnotes {
    margin: 0;
    padding: 0;
    padding-block: var(--ve-markdown-paragraph-padding-block);
    list-style: none;
  ...
  .ve-markdown .ve-md-footnotes__item {
    display: flex;
    align-items: flex-start;
    gap: var(--ve-markdown-list-gap);
    font-size: var(--ve-markdown-body-font-size);
    line-height: var(--ve-markdown-body-line-height);
    font-weight: var(--ve-markdown-body-weight-normal);
    color: var(--ve-markdown-text-color);
  ...
  .ve-markdown .ve-md-footnotes__item + .ve-md-footnotes__item {
    margin-block-start: var(--ve-markdown-list-gap);
  }

  .ve-markdown .ve-md-footnotes__item > .ve-md-footnote-ref {
    flex: none;
    margin-inline: 0;
  }

  .ve-markdown .ve-md-footnotes__content {
    flex: 1 1 auto;
    min-inline-size: 0;
  }
`;
...
const FOOTNOTE_REF_TOKEN = 'footnoteRef';
const FOOTNOTE_DEF_TOKEN = 'footnoteDef';
const FOOTNOTE_LIST_TOKEN = 'footnoteList';
const INLINE_REF_REGEX = /^\[\^([^\]\s]+)\]/;
const BLOCK_DEF_REGEX = /^ {0,3}\[\^([^\]\s]+)\]:[ \t]*([^\n]*(?:\n(?: {4}|\t)[^\n]*)*)/;
const BLOCK_DEF_START_REGEX = /(?:^|\n) {0,3}\[\^[^\]\s]+\]:/;
function slugify(id) {
...
function createFootnoteExtension() {
    ...
    const resetState = ()=>{
        state.order = [];
        state.numberById.clear();
        state.occById.clear();
        state.defs.clear();
    };
    const assignNumber = (id)=>{
        const existing = state.numberById.get(id);
        if (void 0 !== existing) return existing;
        state.order.push(id);
        const num = state.order.length;
        state.numberById.set(id, num);
        return num;
    };
    const refExtension = {
        ...
        start (src) {
            ...
            return idx < 0 ? void 0 : idx;
        },
        tokenizer (src) {
            const match = INLINE_REF_REGEX.exec(src);
            if (!match) return;
            const token = {
                type: FOOTNOTE_REF_TOKEN,
                raw: match[0],
                id: match[1]
            };
            return token;
        ...
        renderer (token) {
            ...
            if (!state.defs.has(id)) return escapeAttr(refToken.raw);
            const num = assignNumber(id);
            const occ = (state.occById.get(id) ?? 0) + 1;
            state.occById.set(id, occ);
            const slug = slugify(id);
            return `<a class="ve-md-footnote-ref" id="fnref-${slug}-${occ}" href="#fn-${slug}"><span class="ve-md-footnote-ref__badge">${num}</span></a>`;
        }
    };
    const defExtension = {
        name: FOOTNOTE_DEF_TOKEN,
        level: 'block',
        start (src) {
            const match = BLOCK_DEF_START_REGEX.exec(src);
            return match ? match.index : void 0;
        },
        tokenizer (src) {
            const match = BLOCK_DEF_REGEX.exec(src);
            if (!match) return;
            const id = match[1];
            const rawContent = (match[2] ?? '').replace(/\n(?: {4}|\t)/g, '\n').trim();
            const inlineTokens = this.lexer.inlineTokens(rawContent);
            state.defs.set(id, {
                tokens: inlineTokens
            });
            const token = {
                type: FOOTNOTE_DEF_TOKEN,
                raw: match[0],
                id,
                tokens: []
            };
    ...
    const listExtension = {
        name: FOOTNOTE_LIST_TOKEN,
        level: 'block',
        start () {},
        tokenizer () {},
        renderer (token) {
            const ids = state.order.filter((id)=>state.defs.has(id));
            if (0 === ids.length) return '';
            const parser = this.parser;
            const items = ids.map((id)=>{
                const def = state.defs.get(id);
                const slug = slugify(id);
                const num = state.numberById.get(id);
                const contentHtml = parser.parseInline(def.tokens);
                const marker = `<a class="ve-md-footnote-ref" href="#fnref-${slug}-1"><span class="ve-md-footnote-ref__badge">${num}</span></a>`;
                return `<li id="fn-${slug}" class="ve-md-footnotes__item">${marker}<span class="ve-md-footnotes__content">${contentHtml}</span></li>`;
            }).join('');
            return `<ul class="ve-md-footnotes">${items}</ul>`;
        }
    };
    return {
        extensions: [
        ...
        hooks: {
            ...
            processAllTokens (tokens) {
                if (0 === state.defs.size) return tokens;
                const list = tokens;
                if (!list.some((t)=>t.type === FOOTNOTE_LIST_TOKEN)) {
                    const listToken = {
                        type: FOOTNOTE_LIST_TOKEN,
                        raw: ''
                    };
                    list.push(listToken);
                }
...
const TAIL_MARKER = Symbol('ve-markdown:tail-marker');
const COMPLETE_FENCED_CODE_REGEX = /^ {0,3}(`{3,}|~{3,})([\s\S]*?)\n {0,3}\1[ \n\t]*$/;
const LANG_NAME_REGEX = /^\S+/;
...
const ESCAPE_TEST_ENCODE = /[&<>"']/;
const ESCAPE_REPLACE_ENCODE = /[&<>"']/g;
const ESCAPE_TEST_NO_ENCODE = /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/;
const ESCAPE_REPLACE_NO_ENCODE = /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g;
const getEscapeReplacement = (ch)=>ESCAPE_REPLACEMENTS[ch] ?? ch;
function escapeHtml(input, encode = false) {
    if (encode) {
        if (ESCAPE_TEST_ENCODE.test(input)) return input.replace(ESCAPE_REPLACE_ENCODE, getEscapeReplacement);
    } else if (ESCAPE_TEST_NO_ENCODE.test(input)) return input.replace(ESCAPE_REPLACE_NO_ENCODE, getEscapeReplacement);
    return input;
}
function findLastNonEmptyToken(tokens) {
    for(let i = tokens.length - 1; i >= 0; i--){
        const token = tokens[i];
        if (token) {
            if ('list' === token.type && Array.isArray(token.items)) {
                const items = token.items;
                for(let j = items.length - 1; j >= 0; j--){
                    const item = items[j];
                    if (item && Array.isArray(item.tokens) && item.tokens.length > 0) {
                        const found = findLastNonEmptyToken(item.tokens);
                        if (found) return found;
                    }
                }
            }
            if (Array.isArray(token.tokens) && token.tokens.length > 0) {
                const found = findLastNonEmptyToken(token.tokens);
                if (found) return found;
            }
            if ('text' === token.type) {
                const text = 'string' == typeof token.text ? token.text : '';
                if (text.trim().length > 0) return token;
                continue;
            }
            'html' === token.type || token.type;
            return token;
        }
    }
}
function findLastTextToken(tokens) {
    const last = findLastNonEmptyToken(tokens);
    if (!last || 'text' !== last.type) return;
    return last;
}
const PROTECT_PLACEHOLDER_PREFIX = '__VE_MD_PROTECT_NL_';
const PROTECT_PLACEHOLDER_SUFFIX = '__';
const PROTECT_PLACEHOLDER_REGEX = /__VE_MD_PROTECT_NL_(\d+)__/g;
class Parser {
    options;
    marked;
    injectTail = false;
    constructor(options = {}){
        ...
        this.configureTableRenderer();
        this.configureHtmlEscapeRenderer();
        this.configureFootnotes();
        this.configureLatex();
        this.configureTailInjection();
        if (this.options.markedConfig) this.marked.use(this.options.markedConfig);
    }
    parse(markdown, parseOptions = {}) {
        if (!markdown) return '';
        this.injectTail = parseOptions.injectTail ?? false;
        if (this.options.protectCustomTagNewlines && this.options.customTags?.length) {
            const { protected: protectedMd, restore } = this.protectCustomTags(markdown);
            const html = this.marked.parse(protectedMd, {
                async: false
            });
            return restore(html);
        }
        ...
        this.marked.use({
            renderer: {
                link ({ href, title, tokens }) {
                    ...
                    const safeHref = 'string' == typeof href ? href : '';
    ...
    configureParagraphRenderer() {
        const tag = this.options.paragraphTag;
        if (!tag || 'p' === tag) return;
        this.marked.use({
            renderer: {
                paragraph ({ tokens }) {
        ...
        this.marked.use({
            renderer: {
                code (token) {
                    ...
                    const escaped = true === codeToken.escaped;
                    const infoString = (codeToken.lang ?? '').toString().trim();
                    const langString = infoString.match(LANG_NAME_REGEX)?.[0] ?? '';
                    const isIndented = 'indented' === codeToken.codeBlockStyle;
                    const status = isIndented || COMPLETE_FENCED_CODE_REGEX.test(raw) ? 'done' : 'loading';
                    const code = `${text.replace(/\n$/, '')}\n`;
                    const escapedCode = escaped ? code : escapeHtml(code, true);
                    const classAttr = langString ? ` class="language-${escapeHtml(langString)}"` : '';
                    const dataAttrs = ` data-block="true" data-state="${status}"` + (infoString ? ` data-lang="${escapeHtml(infoString)}"` : '');
                    return `<ve-md-code-block${dataAttrs}><pre><code${dataAttrs}${classAttr}>${escapedCode}</code></pre></ve-md-code-block>`;
                }
            }
        });
    }
        ...
        this.marked.use({
            renderer: {
                table (token) {
                    ...
                    const parser = this.parser;
                    const renderCells = (cells, tag)=>cells.map((cell)=>{
                            const content = parser.parseInline(cell.tokens);
                            const align = cell.align ? ` align="${cell.align}"` : '';
                            const cls = 'th' === tag ? 've-md-th' : 've-md-td';
                            return `<${tag} class="${cls}"${align}>${content}</${tag}>`;
                        }).join('');
                    const headerHtml = `<thead><tr>${renderCells(tableToken.header, 'th')}</tr></thead>`;
                    const bodyHtml = tableToken.rows.map((row)=>`<tr>${renderCells(row, 'td')}</tr>`).join('');
                    const tableHtml = `<table class="ve-md-tbl">${headerHtml}<tbody>${bodyHtml}</tbody></table>`;
                    return `<ve-md-table data-block="true">${tableHtml}</ve-md-table>`;
                }
            }
        });
    }
        ...
        this.marked.use({
            renderer: {
                html (token) {
                    ...
                    const raw = 'string' == typeof htmlToken.raw ? htmlToken.raw : '';
                    const text = 'string' == typeof htmlToken.text ? htmlToken.text : '';
    ...
    configureFootnotes() {
        this.marked.use(createFootnoteExtension());
    }
    configureLatex() {
        const extensions = this.options.latexExtensions;
    ...
    configureTailInjection() {
        ...
        this.marked.use({
            hooks: {
                processAllTokens (tokens) {
                    if (!self.injectTail) return tokens;
                    const lastText = findLastTextToken(tokens);
                    if (lastText) lastText[TAIL_MARKER] = true;
                    return tokens;
                }
            },
            renderer: {
                text (token) {
                    ...
                    let rendered;
                    rendered = Array.isArray(textToken.tokens) && textToken.tokens.length > 0 ? this.parser.parseInline(textToken.tokens) : textToken.text ?? '';
                    if (textToken[TAIL_MARKER]) {
                        delete textToken[TAIL_MARKER];
                        return `${rendered}<ve-md-tail></ve-md-tail>`;
                    }
                    return rendered;
                }
            }
    ...
    protectCustomTags(markdown) {
        const tags = this.options.customTags ?? [];
        if (0 === tags.length) return {
            protected: markdown,
            restore: (html)=>html
        };
        const tagPattern = tags.map((t)=>t.toLowerCase()).join('|');
        const openRegex = new RegExp(`<(${tagPattern})(\\s[^>]*)?>`, 'gi');
        const closeRegex = new RegExp(`</(${tagPattern})>`, 'gi');
        const stack = [];
        const ranges = [];
        const matches = [];
        let m;
        openRegex.lastIndex = 0;
        while(m = openRegex.exec(markdown))matches.push({
            type: 'open',
        ...
        while(m = closeRegex.exec(markdown))matches.push({
            type: 'close',
            name: m[1].toLowerCase(),
            start: m.index,
            end: m.index + m[0].length
        ...
        for (const match of matches)if ('open' === match.type) stack.push({
            name: match.name,
            start: match.end
        });
        else for(let i = stack.length - 1; i >= 0; i--){
            const frame = stack[i];
            if (frame && frame.name === match.name) {
                if (0 === i) ranges.push({
                    start: frame.start,
                    end: match.start
                });
        ...
        for (const range of ranges){
            ...
            const inside = markdown.slice(range.start, range.end);
            out += inside.replace(/\n{2,}/g, (matched)=>{
                const idx = placeholders.length;
                placeholders.push(matched);
                return `${PROTECT_PLACEHOLDER_PREFIX}${idx}${PROTECT_PLACEHOLDER_SUFFIX}`;
            });
            cursor = range.end;
        }
        out += markdown.slice(cursor);
        const restore = (html)=>html.replace(PROTECT_PLACEHOLDER_REGEX, (_, n)=>{
                const idx = Number(n);
...
function getTagInstanceId(tagName, instanceIndex) {
    return `${tagName.toLowerCase()}-${instanceIndex}`;
}
function skipComment(html, pos) {
    if (!html.startsWith('<!--', pos)) return pos;
    const endPos = html.indexOf('-->', pos + 4);
    return -1 === endPos ? html.length : endPos + 3;
}
function skipCDATA(html, pos) {
    if (!html.startsWith('<![CDATA[', pos)) return pos;
    const endPos = html.indexOf(']]>', pos + 9);
    return -1 === endPos ? html.length : endPos + 3;
}
function skipDeclaration(html, pos) {
    if (!html.startsWith('<!', pos)) return pos;
    const endPos = html.indexOf('>', pos + 2);
    return -1 === endPos ? html.length : endPos + 1;
}
function parseClosingTag(html, pos) {
...
function parseOpeningTag(html, pos) {
    let scanPos = pos + 1;
    let tagName = '';
    while(scanPos < html.length && TAG_NAME_CHAR_REGEX.test(html[scanPos])){
        tagName += html[scanPos];
    ...
    return {
        tagName: tagName.toLowerCase(),
        endPos: foundEnd ? scanPos : html.length,
        foundEnd,
        isSelfClosing
    };
}
function detectUnclosedComponentTags(html, componentNames) {
    ...
    if (!html || 0 === componentNames.length) return result;
    const knownTagSet = new Set(componentNames.map((tag)=>tag.toLowerCase()));
    const tagInstanceCount = new Map();
    const openStack = [];
    let pos = 0;
    while(pos < html.length){
        ...
        const closing = parseClosingTag(html, pos);
        if (closing) {
            if (knownTagSet.has(closing.tagName)) for(let i = openStack.length - 1; i >= 0; i--){
                const candidate = openStack[i];
                if (candidate && candidate.name === closing.tagName) {
        ...
        if (html.startsWith('<!', pos) && !html.startsWith('<![CDATA[', pos)) {
            pos = skipDeclaration(html, pos);
            continue;
        }
        const opening = parseOpeningTag(html, pos);
        if (!opening) {
            pos++;
            continue;
        }
        if (!knownTagSet.has(opening.tagName)) {
            pos = opening.endPos;
            continue;
        }
        const instanceIndex = tagInstanceCount.get(opening.tagName) ?? 0;
        tagInstanceCount.set(opening.tagName, instanceIndex + 1);
        if (opening.foundEnd) {
            if (!opening.isSelfClosing && !VOID_TAGS.has(opening.tagName)) openStack.push({
                name: opening.tagName,
                instanceIndex
            });
        } else result.add(getTagInstanceId(opening.tagName, instanceIndex));
        pos = opening.endPos;
    }
    for (const open of openStack)result.add(getTagInstanceId(open.name, open.instanceIndex));
    return result;
}
const BUILT_IN_TAGS = [
    've-md-tail',
    've-md-code-block',
    've-md-table',
    've-md-animation-text',
    've-md-incomplete-link',
    've-md-incomplete-image',
    've-md-incomplete-html',
    've-md-incomplete-emphasis',
    've-md-incomplete-list',
    've-md-incomplete-table',
    've-md-incomplete-inline-code'
];
const BUILT_IN_ATTRS = [
    'target',
    'rel',
    'data-state',
    'data-lang',
...
const renderer_TAG_NAME_CHAR_REGEX = /[a-zA-Z0-9-]/;
class Renderer {
    options;
    customTags;
    knownTags;
    constructor(options = {}){
        ...
        this.knownTags = Array.from(new Set([
            ...BUILT_IN_TAGS,
            ...this.customTags
        ]));
    }
    sanitize(htmlString) {
        ...
        const unclosed = detectUnclosedComponentTags(htmlString, this.knownTags);
        const annotated = this.annotateTags(htmlString, unclosed);
        return dompurify.sanitize(annotated, this.dompurifyConfig());
    }
    getKnownTags() {
    ...
    annotateTags(html, unclosed) {
        if (0 === this.knownTags.length) return html;
        const knownSet = new Set(this.knownTags.map((t)=>t.toLowerCase()));
        const matches = this.collectOpeningMatches(html, knownSet);
        if (0 === matches.length) return html;
        const instanceCounter = new Map();
        let cursor = 0;
        let out = '';
        for (const item of matches){
            out += html.slice(cursor, item.start);
            cursor = item.end;
            const idx = instanceCounter.get(item.tagName) ?? 0;
            instanceCounter.set(item.tagName, idx + 1);
            const instanceId = getTagInstanceId(item.tagName, idx);
            const isLoading = unclosed.has(instanceId);
            const attrs = item.rawAttrs;
            const hasState = /(^|\s)data-state\s*=/.test(attrs);
            const hasInstance = /(^|\s)data-instance\s*=/.test(attrs);
            let nextAttrs = attrs;
            if (!hasState) nextAttrs += ` data-state="${isLoading ? 'loading' : 'done'}"`;
            if (!hasInstance) nextAttrs += ` data-instance="${instanceId}"`;
            out += item.isSelfClose ? `<${item.tagName}${nextAttrs}></${item.tagName}>` : `<${item.tagName}${nextAttrs}>`;
        }
        out += html.slice(cursor);
        return out;
    }
    collectOpeningMatches(html, knownSet) {
        const result = [];
        let pos = 0;
        while(pos < html.length){
            const afterComment = skipComment(html, pos);
            ...
            if ('/' === html[pos + 1]) {
                ...
                pos = -1 === closeEnd ? html.length : closeEnd + 1;
                continue;
            }
            if (html.startsWith('<!', pos) && !html.startsWith('<![CDATA[', pos)) {
                pos = skipDeclaration(html, pos);
            ...
            const opening = this.parseOpeningForAnnotate(html, pos);
            if (!opening) {
                pos++;
                continue;
            }
            if (opening.foundEnd && knownSet.has(opening.tagName)) result.push({
                start: pos,
                attrsEnd: opening.attrsEnd,
                end: opening.end,
                tagName: opening.tagName,
                rawAttrs: opening.rawAttrs,
                isSelfClose: opening.isSelfClose
            });
            pos = opening.foundEnd ? opening.end : html.length;
        }
        return result;
    }
    parseOpeningForAnnotate(html, pos) {
        let scanPos = pos + 1;
        let tagName = '';
        while(scanPos < html.length && renderer_TAG_NAME_CHAR_REGEX.test(html[scanPos])){
            tagName += html[scanPos];
            scanPos++;
        }
        if (!tagName) return null;
        const attrsStart = scanPos;
        let foundEnd = false;
        ...
        if (!foundEnd) return {
            tagName: tagName.toLowerCase(),
            rawAttrs: html.slice(attrsStart),
            attrsEnd: html.length,
            end: html.length,
            foundEnd: false,
            isSelfClose: false
        };
        const rawAttrsRaw = html.slice(attrsStart, scanPos);
        const rawAttrs = isSelfClose ? rawAttrsRaw.replace(/\/\s*$/, '') : rawAttrsRaw;
        return {
            tagName: tagName.toLowerCase(),
            rawAttrs,
            attrsEnd: scanPos,
...
const INLINE_RULE = /^(?:\${1,2}([^$]{1,10000}?)\${1,2}|\\\(([\s\S]{1,10000}?)\\\)|\\\[((?:\\.|[^\\]){1,10000}?)\\\])/;
const BLOCK_RULE = /^(\${1,2})\n([\s\S]{1,10000}?)\n\1(?:\s*(?:\n|$))|^\\\[((?:\\.|[^\\]){1,10000}?)\\\]/;
function replaceAlign(text) {
    return text ? text.replace(/\{align\*\}/g, '{aligned}') : text;
}
function renderKatex(token, options) {
    return katex.renderToString(token.text, {
        ...options,
        displayMode: token.displayMode
    });
}
function inlineKatex(options, replaceAlignStart) {
    return {
        name: 'inlineKatex',
        level: 'inline',
        start (src) {
        ...
        tokenizer (src) {
            ...
            const text = replaceAlignStart ? replaceAlign(trimmed) : trimmed;
            const displayMode = match[0].startsWith('$$') || void 0 !== match[3];
            return {
                type: 'inlineKatex',
                raw: match[0],
                text,
        ...
        renderer (token) {
            ...
            const html = renderKatex(latexToken, options);
            const cls = latexToken.displayMode ? 'block-katex' : 'inline-katex';
            return `<span class="${cls}">${html}</span>`;
        }
    };
}
function blockKatex(options, replaceAlignStart) {
    return {
        name: 'blockKatex',
        level: 'block',
        tokenizer (src) {
            ...
            if (!match) return;
            const rawText = match[2] ?? (match[3] ? match[3].trim() : '');
...
function createLatexExtensions(katexOptions) {
    const options = {
        output: 'html',
        throwOnError: false,
        ...katexOptions
...
let layoutSheet = null;
function getKatexLayoutSheet(css) {
    if ("u" < typeof CSSStyleSheet) return null;
    if (!layoutSheet) {
        layoutSheet = new CSSStyleSheet();
        layoutSheet.replaceSync(css);
    }
    return layoutSheet;
}
...
const isTableIncomplete = (markdown)=>{
    ...
    if (0 === columns.length) return true;
...
class StreamingBuffer {
    ...
    _token = "text";
    _processedLength = 0;
    push(fullContent, streaming) {
        if ('string' != typeof fullContent) return;
        if (!fullContent) return void this.reset();
        const expectedPrefix = this._committedMarkdown + this._pending;
        if (!fullContent.startsWith(expectedPrefix)) this.reset();
        const chunk = fullContent.slice(this._processedLength);
        if (!chunk) {
            if (!streaming) this.flushIncomplete();
            return;
        }
        this._processedLength += chunk.length;
        for (const char of chunk){
            this._pending += char;
            if (isInCodeBlock(this._committedMarkdown + this._pending)) {
                this.commitCache();
                continue;
            }
            if ("text" !== this._token) {
                const current = recognizers.find((r)=>r.tokenType === this._token);
                if (current) this.recognize(current);
            }
            if ("text" === this._token) for (const recognizer of recognizers)this.recognize(recognizer);
            if ("text" === this._token) this.commitCache();
        }
        if (!streaming) this.flushIncomplete();
    }
    get committedMarkdown() {
        return this._committedMarkdown;
    }
    get pending() {
    ...
    reset() {
        this._committedMarkdown = '';
        this._pending = '';
        this._token = "text";
        this._processedLength = 0;
    }
    recognize(recognizer) {
        if ("text" === this._token && recognizer.isStartOfToken(this._pending)) {
            this._token = recognizer.tokenType;
            return;
        }
        if (this._token === recognizer.tokenType && !recognizer.isStreamingValid(this._pending)) {
            const prefix = recognizer.getCommitPrefix?.(this._pending) ?? null;
            if (prefix) {
                this._committedMarkdown += prefix;
                this._pending = this._pending.slice(prefix.length);
                this._token = "text";
                return;
            }
            this.commitCache();
    ...
    commitCache() {
        if (this._pending) {
            this._committedMarkdown += this._pending;
            this._pending = '';
        }
        this._token = "text";
    }
...
let _dec, _init_dataState, _init_extra__init_dataState;
const VE_MD_TAIL_TAG = 've-md-tail';
_dec = property({
    type: String,
    attribute: 'data-state',
    reflect: true
});
class VeMdTailElement extends VeElement {
    static{
        ({ e: [_init_dataState, _init_extra__init_dataState] } = _apply_decs_2311(this, [], [
            [
                _dec,
                1,
                "dataState"
    ...
    static styles = external_lit_css`
    :host {
      ...
      animation: ve-md-tail-blink 1s steps(1, end) infinite;
    }

    @keyframes ve-md-tail-blink {
      0%,
      50% {
        opacity: 1;
      }
  ...
  `;
    #___private_dataState_1 = (()=>{
        const _value = _init_dataState(this, 'loading');
        _init_extra__init_dataState(this);
        return _value;
    })();
    get dataState() {
        return this.#___private_dataState_1;
    }
    set dataState(_v) {
        this.#___private_dataState_1 = _v;
    }
    render() {
        return external_lit_html``;
    }
}
function ve_md_code_block_element_toPrimitive(input, hint) {
    if ("object" != typeof input || null === input) return input;
    var prim = input[Symbol.toPrimitive];
    if (void 0 !== prim) {
        var res = prim.call(input, hint || "default");
...
function ve_md_code_block_element_toPropertyKey(arg) {
    var key = ve_md_code_block_element_toPrimitive(arg, "string");
    return "symbol" == typeof key ? key : String(key);
}
function ve_md_code_block_element_checkInRHS(value) {
    if (Object(value) !== value) throw TypeError("right-hand side of 'in' should be an object, got " + (null !== value ? typeof value : "null"));
    return value;
}
function ve_md_code_block_element_setFunctionName(fn, name, prefix) {
    if ("symbol" == typeof name) {
        name = name.description;
        name = name ? "[" + name + "]" : "";
    }
...
function ve_md_code_block_element_apply_decs_2311(targetClass, classDecs, memberDecs, classDecsHaveThis, instanceBrand, parentClass) {
    var symbolMetadata = Symbol.metadata || Symbol.for("Symbol.metadata");
    var defineProperty = Object.defineProperty;
    var create = Object.create;
    var metadata;
    ...
    function applyDec(Class, decInfo, decoratorsHaveThis, name, kind, initializers, ret, isStatic, isPrivate, isField, hasPrivateBrand) {
        ...
        if (!isClass) {
            if (isPrivate) {
                if (isField || isAccessor) desc1 = {
                    get: ve_md_code_block_element_setFunctionName(function() {
                        return decVal(this);
                    }, name, "get"),
                    set: function(value) {
                        decInfo[4](this, value);
                ...
                if (!isField) ve_md_code_block_element_setFunctionName(desc1[key], name, isMethod ? "" : key);
            } else if (!isField) desc1 = Object.getOwnPropertyDescriptor(Class, name);
            if (!isField && !isPrivate) {
                _ = existingNonFields[+isStatic][name];
                if (_ && (_ ^ kind) !== 7) throw new Error("Decorating two elements with the same name (" + desc1[key].name + ") is not supported yet");
        ...
        var applyMemberDecsOfKind = function(isStatic, isField) {
            for(var i = 0; i < memberDecs.length; i++){
                ...
                if ((8 & kind) == isStatic && !kindOnly == isField) {
                    ...
                    var isPrivate = !!decInfo[3];
                    var decoratorsHaveThis = 16 & kind;
                    applyDec(isStatic ? targetClass : targetClass.prototype, decInfo, decoratorsHaveThis, isPrivate ? "#" + name : ve_md_code_block_element_toPropertyKey(name), kindOnly, kindOnly < 2 ? [] : isStatic ? staticInitializers = staticInitializers || [] : protoInitializers = protoInitializers || [], ret, !!isStatic, isPrivate, isField, isStatic && isPrivate ? function(_) {
                        return ve_md_code_block_element_checkInRHS(_) === targetClass;
                    } : instanceBrand);
                }
            }
        };
...
let ve_md_code_block_element_dec, _dec1, _dec2, _dec3, _dec4, _dec5, _dec6, ve_md_code_block_element_init_dataState, ve_md_code_block_element_init_extra_init_dataState, _init_dataLang, _init_extra__init_dataLang, _init_showCopy, _init_extra__init_showCopy, _init_showDownload, _init_extra__init_showDownload, _init_fileName, _init_extra__init_fileName, _init__copyState, _init_extra__init__copyState, _init__sourceText, _init_extra__init__sourceText;
const VE_MD_CODE_BLOCK_TAG = 've-md-code-block';
const { highlight: prismHighlight, languages: prismLanguages } = prismjs;
...
function resolveLanguage(rawLang) {
    const lang = (rawLang || '').toLowerCase().split(/\s+/)[0] ?? '';
    return LANGUAGE_ALIAS[lang] ?? lang;
}
function ve_md_code_block_element_escapeHtml(text) {
    return text.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#39;');
}
ve_md_code_block_element_dec = property({
    type: String,
    attribute: 'data-state',
    reflect: true
}), _dec1 = property({
    ...
    type: String,
    attribute: 'file-name'
}), _dec5 = decorators_js_state(), _dec6 = decorators_js_state();
class VeMdCodeBlockElement extends VeElement {
    static{
        ({ e: [ve_md_code_block_element_init_dataState, ve_md_code_block_element_init_extra_init_dataState, _init_dataLang, _init_extra__init_dataLang, _init_showCopy, _init_extra__init_showCopy, _init_showDownload, _init_extra__init_showDownload, _init_fileName, _init_extra__init_fileName, _init__copyState, _init_extra__init__copyState, _init__sourceText, _init_extra__init__sourceText] } = ve_md_code_block_element_apply_decs_2311(this, [], [
            [
                ve_md_code_block_element_dec,
                1,
                "dataState"
            ],
            [
    ...
    :host {
      ...
      box-sizing: border-box;
      inline-size: 100%;
      margin-block-start: var(--ve-markdown-code-block-margin-block-start, var(--space-xxxs, 4px));
      margin-block-end: var(--ve-markdown-code-block-margin-block-end, var(--space-xs, 12px));
      color: var(--ve-markdown-code-text-color);
      font-family: var(--ve-markdown-code-font-family, monospace);
      font-size: var(--ve-markdown-code-font-size);
      line-height: var(--ve-markdown-code-line-height);

      /* Prism token palette — light scheme */
      --ve-md-code-text: #000000d9;
      --ve-md-code-doc: #00000073;
      --ve-md-code-link: #2f74ff;
      --ve-md-code-number: #e54595;
      --ve-md-code-keycontrol: #9952e1;
      --ve-md-code-function: #ff5d4d;
      --ve-md-code-variable: #000000d9;
      --ve-md-code-parameter: #4da621;
      --ve-md-code-attributes: #cc7700;
      --ve-md-code-property: #c99100;
      --ve-md-code-selector: #36b2ab;
      --ve-md-code-keyword: #b15ef2;
      --ve-md-code-instruction: #b15ef2;
      --ve-md-code-inserted: #70c632ed;
    }

    :host-context(.dark) {
      /* Prism token palette — dark scheme */
      --ve-md-code-text: #ffffffd9;
      --ve-md-code-doc: #ffffff80;
      --ve-md-code-link: #709cf2;
      --ve-md-code-number: #d389cb;
      --ve-md-code-keycontrol: #9d89eb;
      --ve-md-code-function: #f29d79;
      --ve-md-code-variable: #ffffffd9;
      --ve-md-code-parameter: #69bd8b;
      --ve-md-code-attributes: #ded47e;
      --ve-md-code-property: #ded47e;
      --ve-md-code-selector: #6cd0c8;
      --ve-md-code-keyword: #c39bf2;
      --ve-md-code-instruction: #c39bf2;
      --ve-md-code-inserted: #8fd86b;
    }

    /* Frame — 边框/圆角/背景放在 shadow DOM 内部容器上，避免被宿主页面的
     * 全局 reset（如 Tailwind preflight 的 *{border-width:0}）覆盖。React 包装器
     * 会把代码块 hoist 到 light DOM，此时 :host 与外部 reset 同特异度，:host 会落败。 */
    .ve-md-code-frame {
      display: flex;
    ...
    .ve-md-code-header {
      ...
      block-size: var(--ve-markdown-code-header-height);
      padding-inline: var(--ve-markdown-code-header-padding-inline);
      background: var(--ve-markdown-code-header-background);
      color: var(--ve-markdown-code-header-color);
      border-block-end: var(--ve-markdown-code-header-border-width) solid
        var(--ve-markdown-code-header-border-color);
      user-select: none;
    }
    ...
    .ve-md-code-label {
      ...
      display: flex;
      align-items: center;
      gap: var(--ve-markdown-code-header-gap);
      color: var(--ve-markdown-code-label-color);
      font-family: var(--ve-markdown-code-title-font-family);
      font-size: var(--ve-markdown-code-title-font-size);
      line-height: var(--ve-markdown-code-title-line-height);
      overflow: hidden;
      text-overflow: ellipsis;
      white-space: nowrap;
    }

    .ve-md-code-label-icon {
      flex-shrink: 0;
      display: inline-flex;
      inline-size: 1rem;
      block-size: 1rem;
      color: var(--ve-markdown-code-copy-color);
    }

    .ve-md-code-label-icon svg {
      inline-size: 100%;
      block-size: 100%;
      display: block;
    }
    ...
    .ve-md-code-copy {
      ...
      margin: 0;
      border: 0;
      border-radius: var(--ve-markdown-code-copy-radius);
      background: transparent;
      color: var(--ve-markdown-code-copy-color);
      cursor: pointer;
      transition: background-color var(--motion-fast, 150ms)
        var(--ease-standard, ease);
    }

    .ve-md-code-copy:hover {
      background-color: var(--ve-markdown-code-copy-hover-background);
    }

    .ve-md-code-copy:active {
      background-color: var(--ve-markdown-code-copy-active-background);
    }

    .ve-md-code-copy[disabled] {
      opacity: 0.5;
      cursor: default;
    }

    .ve-md-code-copy ve-icon {
      display: block;
      --ve-icon-size: 1rem;
    }
    ...
    .ve-md-code-body::-webkit-scrollbar {
      block-size: 4px;
    }

    .ve-md-code-body::-webkit-scrollbar-thumb {
      background-color: var(--ve-markdown-code-scrollbar-color);
      border-radius: 4px;
    }
    ...
    code {
      ...
      padding: 0;
      background: transparent;
      color: var(--ve-md-code-text);
      font: inherit;
    }

    pre {
      white-space: var(--ve-markdown-code-block-white-space, pre);
      word-break: break-word;
    }
    ...
    ::selection {
      background: var(--ve-markdown-code-selection-background);
      text-shadow: none;
    }

    /* PrismJS token colors — sourced from prism-code-block-highlighter */
    .token.comment,
    .token.prolog,
    .token.doctype,
    .token.cdata {
      color: var(--ve-md-code-doc);
    }
    ...
    .token.symbol,
    .token.deleted {
      color: var(--ve-md-code-number);
    }

    .token.instruction {
      color: var(--ve-md-code-instruction);
    }

    .token.link {
      color: var(--ve-md-code-link);
    }

    .token.selector {
      color: var(--ve-md-code-selector);
    }

    .token.parameter,
    .token.string,
    .token.attr-value {
      color: var(--ve-md-code-parameter);
    }

    .token.property,
    .token.attr-name {
      color: var(--ve-md-code-property);
    }
    ...
    .token.char,
    .token.inserted {
      color: var(--ve-md-code-inserted);
    }

    .token.property-access {
      color: var(--ve-md-code-attributes);
    }

    .token.function,
    .token.builtin {
      color: var(--ve-md-code-function);
    }

    .token.atrule {
      color: var(--ve-md-code-keyword);
    }
  ...
  `
    ...
    #___private_dataState_1 = (()=>{
        const _value = ve_md_code_block_element_init_dataState(this, 'done');
        ve_md_code_block_element_init_extra_init_dataState(this);
        return _value;
    })();
    get dataState() {
        return this.#___private_dataState_1;
    ...
    #___private_dataLang_2 = (()=>{
        const _value = _init_dataLang(this, '');
        _init_extra__init_dataLang(this);
        return _value;
    })();
    get dataLang() {
        return this.#___private_dataLang_2;
    }
    set dataLang(_v) {
        this.#___private_dataLang_2 = _v;
    }
    #___private_showCopy_3 = (()=>{
        const _value = _init_showCopy(this, true);
        _init_extra__init_showCopy(this);
        return _value;
    })();
    get showCopy() {
        return this.#___private_showCopy_3;
    }
    set showCopy(_v) {
        this.#___private_showCopy_3 = _v;
    }
    #___private_showDownload_4 = (()=>{
        const _value = _init_showDownload(this, true);
        _init_extra__init_showDownload(this);
        return _value;
    })();
    get showDownload() {
        return this.#___private_showDownload_4;
    }
    set showDownload(_v) {
        this.#___private_showDownload_4 = _v;
    }
    #___private_fileName_5 = (()=>{
        const _value = _init_fileName(this, 'code');
        _init_extra__init_fileName(this);
        return _value;
    })();
    get fileName() {
        return this.#___private_fileName_5;
    }
    set fileName(_v) {
        this.#___private_fileName_5 = _v;
    }
    #___private__copyState_6 = (()=>{
        const _value = _init__copyState(this, 'idle');
        _init_extra__init__copyState(this);
        return _value;
    })();
    get _copyState() {
        return this.#___private__copyState_6;
    }
    set _copyState(_v) {
        this.#___private__copyState_6 = _v;
    }
    #___private__sourceText_7 = (()=>{
        const _value = _init__sourceText(this, '');
        _init_extra__init__sourceText(this);
        return _value;
    })();
    get _sourceText() {
        return this.#___private__sourceText_7;
    }
    set _sourceText(_v) {
        this.#___private__sourceText_7 = _v;
    }
    _copyResetTimer = null;
    _lightDomObserver = null;
    connectedCallback() {
        super.connectedCallback();
        this.syncSourceFromLightDom();
    ...
    syncSourceFromLightDom() {
        const codeEl = this.querySelector('code');
        const raw = (codeEl?.textContent ?? this.textContent ?? '').replace(/\n$/, '');
        if (raw !== this._sourceText) this._sourceText = raw;
    }
    render() {
        const language = resolveLanguage(this.dataLang);
        const highlighted = this.highlight(this._sourceText, language);
        return external_lit_html`
      <div class="ve-md-code-frame">
        <header class="ve-md-code-header" part="header">
          <span class="ve-md-code-label" part="label">
            <span>${this.dataLang || 'text'}</span>
          </span>
          <span class="ve-md-code-actions" part="actions">
            ${this.showCopy ? external_lit_html`<span class="ve-md-code-action-item">${this.renderCopyButton()}</span>` : nothing}
            ${this.showDownload ? external_lit_html`<span class="ve-md-code-action-item">${this.renderDownloadButton()}</span>` : nothing}
          </span>
        </header>
        <div class="ve-md-code-body" part="body">
          <pre part="pre" class="language-${language}"><code
            part="code"
            class="language-${language}"
          >${unsafeHTML(highlighted)}</code></pre>
          <div class="ve-md-code-source" aria-hidden="true">
    ...
    handleSlotChange = (event)=>{
        ...
        this._sourceText = text.replace(/\n$/, '');
    };
    highlight(code, language) {
        if (!code) return '';
        if ('plaintext' === language) return ve_md_code_block_element_escapeHtml(code);
        const grammar = prismLanguages[language];
        if (!grammar) return ve_md_code_block_element_escapeHtml(code);
        try {
            return prismHighlight(code, grammar, language);
        } catch  {
            return ve_md_code_block_element_escapeHtml(code);
        }
    }
    renderCopyButton() {
        const ariaLabel = 'copied' === this._copyState ? 'Copied' : 'error' === this._copyState ? 'Copy failed' : 'Copy code';
        return external_lit_html`
      <button
        type="button"
        class="ve-md-code-copy"
        part="copy"
        aria-label=${ariaLabel}
        @click=${this.handleCopyClick}
      >
        <ve-icon .definition=${'copied' === this._copyState ? checkIcon : copyIcon} size="16"></ve-icon>
      </button>
    `;
    }
    handleCopyClick = async ()=>{
        const text = this._sourceText;
        if (!text) return void this.markCopyState('error');
        try {
    ...
    renderDownloadButton() {
      ...
      >
        <ve-icon .definition=${downloadIcon} size="16"></ve-icon>
      </button>
    `;
    }
    handleDownloadClick = ()=>{
        ...
        const name = `${this.fileName || 'code'}.${ext}`;
        try {
            const blob = new Blob([
                text
            ], {
        ...
        this.dispatchEvent(new CustomEvent('md-code-download', {
            detail: {
                fileName: name,
                content: text,
                language
...
function ve_md_table_element_toPrimitive(input, hint) {
    if ("object" != typeof input || null === input) return input;
    var prim = input[Symbol.toPrimitive];
    if (void 0 !== prim) {
        var res = prim.call(input, hint || "default");
...
function ve_md_table_element_toPropertyKey(arg) {
    var key = ve_md_table_element_toPrimitive(arg, "string");
    return "symbol" == typeof key ? key : String(key);
}
function ve_md_table_element_checkInRHS(value) {
    if (Object(value) !== value) throw TypeError("right-hand side of 'in' should be an object, got " + (null !== value ? typeof value : "null"));
    return value;
}
function ve_md_table_element_setFunctionName(fn, name, prefix) {
    if ("symbol" == typeof name) {
        name = name.description;
        name = name ? "[" + name + "]" : "";
    }
...
function ve_md_table_element_apply_decs_2311(targetClass, classDecs, memberDecs, classDecsHaveThis, instanceBrand, parentClass) {
    var symbolMetadata = Symbol.metadata || Symbol.for("Symbol.metadata");
    var defineProperty = Object.defineProperty;
    var create = Object.create;
    var metadata;
    ...
    function applyDec(Class, decInfo, decoratorsHaveThis, name, kind, initializers, ret, isStatic, isPrivate, isField, hasPrivateBrand) {
        ...
        if (!isClass) {
            if (isPrivate) {
                if (isField || isAccessor) desc1 = {
                    get: ve_md_table_element_setFunctionName(function() {
                        return decVal(this);
                    }, name, "get"),
                    set: function(value) {
                        decInfo[4](this, value);
                ...
                if (!isField) ve_md_table_element_setFunctionName(desc1[key], name, isMethod ? "" : key);
            } else if (!isField) desc1 = Object.getOwnPropertyDescriptor(Class, name);
            if (!isField && !isPrivate) {
                _ = existingNonFields[+isStatic][name];
                if (_ && (_ ^ kind) !== 7) throw new Error("Decorating two elements with the same name (" + desc1[key].name + ") is not supported yet");
        ...
        var applyMemberDecsOfKind = function(isStatic, isField) {
            for(var i = 0; i < memberDecs.length; i++){
                ...
                if ((8 & kind) == isStatic && !kindOnly == isField) {
                    ...
                    var isPrivate = !!decInfo[3];
                    var decoratorsHaveThis = 16 & kind;
                    applyDec(isStatic ? targetClass : targetClass.prototype, decInfo, decoratorsHaveThis, isPrivate ? "#" + name : ve_md_table_element_toPropertyKey(name), kindOnly, kindOnly < 2 ? [] : isStatic ? staticInitializers = staticInitializers || [] : protoInitializers = protoInitializers || [], ret, !!isStatic, isPrivate, isField, isStatic && isPrivate ? function(_) {
                        return ve_md_table_element_checkInRHS(_) === targetClass;
                    } : instanceBrand);
                }
            }
        };
...
let ve_md_table_element_dec, ve_md_table_element_dec1, ve_md_table_element_dec2, ve_md_table_element_dec3, ve_md_table_element_dec4, ve_md_table_element_dec5, ve_md_table_element_init_dataState, ve_md_table_element_init_extra_init_dataState, _init_scrollState, _init_extra__init_scrollState, _init_toolbar, _init_extra__init_toolbar, ve_md_table_element_init_fileName, ve_md_table_element_init_extra_init_fileName, _init__ready, _init_extra__init__ready, _init__scrollEl, _init_extra__init__scrollEl;
const VE_MD_TABLE_TAG = 've-md-table';
...
ve_md_table_element_dec = property({
    type: String,
    attribute: 'data-state',
    reflect: true
}), ve_md_table_element_dec1 = property({
    type: String,
    attribute: 'scroll-state',
    reflect: true
}), ve_md_table_element_dec2 = property({
    type: Boolean,
    attribute: 'toolbar'
}), ve_md_table_element_dec3 = property({
    type: String,
    attribute: 'file-name'
}), ve_md_table_element_dec4 = decorators_js_state(), ve_md_table_element_dec5 = query('.ve-md-table-scroll');
class VeMdTableElement extends VeElement {
    static{
        ({ e: [ve_md_table_element_init_dataState, ve_md_table_element_init_extra_init_dataState, _init_scrollState, _init_extra__init_scrollState, _init_toolbar, _init_extra__init_toolbar, ve_md_table_element_init_fileName, ve_md_table_element_init_extra_init_fileName, _init__ready, _init_extra__init__ready, _init__scrollEl, _init_extra__init__scrollEl] } = ve_md_table_element_apply_decs_2311(this, [], [
            [
                ve_md_table_element_dec,
                1,
                "dataState"
            ],
            [
                ve_md_table_element_dec1,
                1,
                "scrollState"
            ],
            [
                ve_md_table_element_dec2,
                1,
                "toolbar"
            ],
            [
                ve_md_table_element_dec3,
                1,
                "fileName"
            ],
            [
                ve_md_table_element_dec4,
                1,
                "_ready"
            ],
            [
                ve_md_table_element_dec5,
                1,
                "_scrollEl"
            ]
        ]));
    ...
    :host {
      ...
      margin-block-start: var(
        --ve-markdown-table-margin-block-start,
        var(--space-xxxs, 4px)
      );
      margin-block-end: var(
        --ve-markdown-table-margin-block-end,
        var(--space-xs, 12px)
      );
      font-family: var(
        --ve-markdown-table-font-family,
        var(--font-sans, 'PingFang SC', sans-serif)
      );
      color: var(
        --ve-markdown-table-cell-text,
        var(--color-text-primary, #101013)
      );

      /* ── 内部私有 token ── */
      --_table-bg: var(--ve-markdown-table-bg, var(--color-bg-base, #ffffff));
      --_table-divider: var(
        --ve-markdown-table-divider,
        var(--color-border-default, #d2d1e0)
      );
      --_table-divider-width: var(--ve-markdown-table-divider-width, 0.5px);
      --_table-font-size: var(--ve-markdown-table-font-size, 14px);
      --_table-line-height: var(--ve-markdown-table-line-height, 23px);
      --_table-padding-inline: var(
        --ve-markdown-table-padding-inline,
        var(--space-s, 16px)
      );
      --_table-header-padding-block: var(
        --ve-markdown-table-header-padding-block,
        var(--space-xxs, 8px)
      );
      --_table-cell-padding-block: var(
        --ve-markdown-table-cell-padding-block,
        var(--space-xs, 12px)
      );
      --_table-max-block-size: var(--ve-markdown-table-max-block-size, none);
      --_table-cell-max-width: var(--ve-markdown-table-cell-max-width, none);
      --_fade-width: var(--ve-markdown-table-fade-width, 30px);
      --_fade-color: var(
        --ve-markdown-table-fade-color,
        var(--color-bg-base, #ffffff)
      );
      --_toolbar-fade: var(
        --ve-markdown-table-toolbar-fade,
        var(--color-bg-base, #ffffff)
      );
      --_icon-button-size: var(--ve-markdown-table-icon-button-size, 28px);
      --_icon-button-padding: var(--ve-markdown-table-icon-button-padding, 6px);
      --_icon-size: var(--ve-markdown-table-icon-size, 16px);
      --_icon-radius: var(
        --ve-markdown-table-icon-radius,
        var(--radius-xs, 4px)
      );
      --_icon-color: var(
        --ve-markdown-table-icon-color,
        var(--color-text-secondary, #383740)
      );
      --_icon-hover-bg: var(
        --ve-markdown-table-icon-hover-bg,
        var(--color-bg-muted, #f2f2f2)
      );
      --_transition-duration: var(
        --ve-markdown-table-transition-duration,
        160ms
      );
      --_transition-ease: var(--ve-markdown-table-transition-ease, ease);
    }

    /* ---------- table / th / td 样式（shadow DOM 内直接生效） ---------- */
    .ve-md-tbl {
    ...
    .ve-md-th {
      box-sizing: border-box;
      padding-block: var(--_table-header-padding-block);
      padding-inline: var(--_table-padding-inline);
      background: transparent;
      border-block-end: var(--_table-divider-width) solid var(--_table-divider);
      font-size: var(--_table-font-size);
      line-height: var(--_table-line-height);
      text-align: start;
      vertical-align: middle;
      color: var(
        --ve-markdown-table-header-text,
        var(--color-text-primary, #101013)
      );
      font-weight: var(--ve-markdown-table-header-font-weight, 500);
      white-space: nowrap;
    }
    ...
    .ve-md-td {
      ...
      font-weight: var(--ve-markdown-table-cell-font-weight, 400);
      white-space: normal;
      word-break: break-word;
      max-inline-size: var(--_table-cell-max-width);
    }

    /* ---------- 单元格内联样式（与 ve-markdown 主体保持一致） ---------- */
    :where(.ve-md-th, .ve-md-td) :where(strong, b) {
      font-style: normal;
      font-weight: var(--ve-markdown-body-weight-emphasis, 500);
      color: inherit;
    }

    :where(.ve-md-th, .ve-md-td) :where(em, i) {
      font-style: italic;
      font-weight: var(--ve-markdown-body-weight-normal, 400);
      color: inherit;
    }

    :where(.ve-md-th, .ve-md-td) a {
      color: var(--ve-markdown-link-color, #165dff);
      font-family: var(--ve-markdown-font-family, inherit);
      font-size: inherit;
      line-height: inherit;
      text-decoration: underline;
      text-decoration-color: var(
        --ve-markdown-link-decoration-color,
        currentColor
      );
      text-decoration-style: dotted;
      text-decoration-thickness: var(
        --ve-markdown-link-decoration-thickness,
        from-font
      );
      text-underline-offset: var(--ve-markdown-link-decoration-offset, 2px);
      word-break: break-word;
    }

    :where(.ve-md-th, .ve-md-td) a:hover {
      color: var(--ve-markdown-link-hover-color, #4080ff);
      text-decoration-style: solid;
    }

    :where(.ve-md-th, .ve-md-td) :not(pre) > code {
      box-sizing: border-box;
      padding-block: var(--ve-markdown-inline-code-padding-block, 1px);
      padding-inline: var(--ve-markdown-inline-code-padding-inline, 4px);
      border: var(--ve-markdown-inline-code-border-width, 0.5px) solid
        var(
          --ve-markdown-inline-code-border-color,
          var(--color-border-default, #d2d1e0)
        );
      border-radius: var(
        --ve-markdown-inline-code-radius,
        var(--radius-xs, 4px)
      );
      background: var(
        --ve-markdown-inline-code-background,
        var(--color-bg-muted, #f2f2f2)
      );
      color: var(--ve-markdown-inline-code-color, inherit);
      font-family: var(
        --ve-markdown-inline-code-font-family,
        var(--font-mono, monospace)
      );
      font-size: var(--ve-markdown-inline-code-font-size, 0.9em);
      line-height: var(--ve-markdown-inline-code-line-height, 1.4);
      vertical-align: baseline;
      word-break: break-word;
      -webkit-box-decoration-break: clone;
      box-decoration-break: clone;
    ...
    :where(.ve-md-th, .ve-md-td) blockquote {
      display: flex;
      align-items: stretch;
      margin: 0;
      padding-block: var(--ve-markdown-blockquote-padding-block, 0);
      padding-inline: 0;
      background: transparent;
    }

    :where(.ve-md-th, .ve-md-td) blockquote::before {
      content: '';
      flex: none;
      align-self: stretch;
      inline-size: var(--ve-markdown-blockquote-border-width, 2px);
      background: var(
        --ve-markdown-blockquote-border-color,
        var(--color-border-default, #d2d1e0)
      );
      border-radius: 0;
      margin-inline-end: var(--ve-markdown-blockquote-padding-inline, 8px);
    }

    :where(.ve-md-th, .ve-md-td) blockquote > * {
      color: var(--ve-markdown-text-color, inherit);
      font-size: inherit;
      line-height: var(--ve-markdown-blockquote-line-height, inherit);
      font-weight: var(--ve-markdown-body-weight-normal, 400);
      word-break: break-word;
    }

    :where(.ve-md-th, .ve-md-td) :where(ul, ol) {
      margin: 0;
      padding-block: 0;
      padding-inline-start: var(--ve-markdown-list-marker-width, 1.25em);
      color: inherit;
    }

    :where(.ve-md-th, .ve-md-td) li::marker {
      color: var(--ve-markdown-list-marker-color, currentColor);
    }

    /* ---------- 横向滚动容器 ---------- */
    .ve-md-table-scroll {
      inline-size: 100%;
      max-block-size: var(--_table-max-block-size);
      overflow-x: auto;
      overflow-y: auto;
      scrollbar-width: thin;
    }

    .ve-md-table-scroll::-webkit-scrollbar {
      block-size: 4px;
    }

    .ve-md-table-scroll::-webkit-scrollbar-thumb {
      background-color: var(--_table-divider);
      border-radius: 4px;
    }
    ...
    .ve-md-table-fade {
      position: absolute;
      inset-block: 0;
      inline-size: var(--_fade-width);
      z-index: 2;
      pointer-events: none;
      opacity: 0;
      transition: opacity var(--_transition-duration) var(--_transition-ease);
    }

    .ve-md-table-fade--start {
      inset-inline-start: 0;
      background: linear-gradient(to right, var(--_fade-color), transparent);
    }

    .ve-md-table-fade--end {
      inset-inline-end: 0;
      background: linear-gradient(to left, var(--_fade-color), transparent);
    }

    :host([scroll-state='start']) .ve-md-table-fade--end,
    :host([scroll-state='middle']) .ve-md-table-fade--end,
    :host([scroll-state='middle']) .ve-md-table-fade--start,
    :host([scroll-state='end']) .ve-md-table-fade--start {
      opacity: 1;
    }
    ...
    .ve-md-table-toolbar {
      ...
      z-index: 3;
      block-size: calc(
        var(--_table-line-height) + 2 * var(--_table-header-padding-block)
      );
      display: flex;
      align-items: center;
      gap: var(--space-xxxs, 4px);
      padding-block: 0;
      padding-inline-start: var(--space-xl, 32px);
      padding-inline-end: var(--space-xs, 12px);
      background: linear-gradient(
        to right,
        transparent,
        var(--_toolbar-fade) 26%
      );
      opacity: 0;
      pointer-events: none;
      transition: opacity var(--_transition-duration) var(--_transition-ease);
    ...
    :host(:hover) .ve-md-table-toolbar,
    :host(:focus-within) .ve-md-table-toolbar {
      opacity: 1;
      pointer-events: auto;
    }

    /* ---------- 图标按钮 ---------- */
    .ve-md-table-icon-button {
      display: inline-flex;
      align-items: center;
      justify-content: center;
    ...
    .ve-md-table-icon-button:hover {
      background: var(--_icon-hover-bg);
    }

    .ve-md-table-icon-button:focus-visible {
      outline: var(--_table-divider-width) solid var(--_icon-color);
      outline-offset: 1px;
    }

    .ve-md-table-icon-button ve-icon {
      display: block;
      --ve-icon-size: var(--_icon-size);
    }
  ...
  `;
    #___private_dataState_1 = (()=>{
        const _value = ve_md_table_element_init_dataState(this, 'done');
        ve_md_table_element_init_extra_init_dataState(this);
        return _value;
    })();
    get dataState() {
        return this.#___private_dataState_1;
    ...
    #___private_scrollState_2 = (()=>{
        const _value = _init_scrollState(this, 'none');
        _init_extra__init_scrollState(this);
        return _value;
    })();
    get scrollState() {
        return this.#___private_scrollState_2;
    }
    set scrollState(_v) {
        this.#___private_scrollState_2 = _v;
    }
    #___private_toolbar_3 = (()=>{
        const _value = _init_toolbar(this, true);
        _init_extra__init_toolbar(this);
        return _value;
    })();
    get toolbar() {
        return this.#___private_toolbar_3;
    }
    set toolbar(_v) {
        this.#___private_toolbar_3 = _v;
    }
    #___private_fileName_4 = (()=>{
        const _value = ve_md_table_element_init_fileName(this, 'table');
        ve_md_table_element_init_extra_init_fileName(this);
        return _value;
    })();
    get fileName() {
        return this.#___private_fileName_4;
    }
    set fileName(_v) {
        this.#___private_fileName_4 = _v;
    }
    #___private__ready_5 = (()=>{
        const _value = _init__ready(this, false);
        _init_extra__init__ready(this);
        return _value;
    })();
    get _ready() {
        return this.#___private__ready_5;
    }
    set _ready(_v) {
        this.#___private__ready_5 = _v;
    }
    #___private__scrollEl_6 = (()=>{
        const _value = _init__scrollEl(this);
        _init_extra__init__scrollEl(this);
        return _value;
    })();
    get _scrollEl() {
        return this.#___private__scrollEl_6;
    }
    set _scrollEl(_v) {
        this.#___private__scrollEl_6 = _v;
    }
    ...
    connectedCallback() {
        super.connectedCallback();
        this._throttledUpdate = throttle(()=>this._updateScrollState(), 50);
    ...
    _adoptTable() {
        ...
        if (table && table.parentNode !== scroll) {
            scroll.appendChild(table);
            this._slotTable = table;
            this._bindObservers();
            this._throttledUpdate?.();
        } else if (!table && this._slotTable) this._slotTable = null;
    }
    _bindObservers() {
        this._resizeObserver?.disconnect();
        const scroll = this._scrollEl;
        if (!scroll || "u" < typeof ResizeObserver) return;
        this._resizeObserver = new ResizeObserver(()=>{
            this._throttledUpdate?.();
        });
        this._resizeObserver.observe(scroll);
        if (this._slotTable) this._resizeObserver.observe(this._slotTable);
    }
    _updateScrollState() {
        ...
        let next = 'none';
        if (maxScroll > 1) next = el.scrollLeft <= 1 ? 'start' : el.scrollLeft >= maxScroll - 1 ? 'end' : 'middle';
        if (next !== this.scrollState) this.scrollState = next;
    }
    _handleScroll = ()=>{
        this._throttledUpdate?.();
    };
    _collectData() {
        const table = this._slotTable;
        if (!table) return {
            headers: [],
            rows: []
        };
        ...
        const rows = Array.from(bodyRows).map((tr)=>Array.from(tr.querySelectorAll('th, td')).map((c)=>c.textContent?.trim() ?? ''));
        return {
            headers,
            rows
        };
    ...
    _handleCopy = async ()=>{
        ...
        const text = this._toMarkdown(data);
        try {
            if (navigator.clipboard?.writeText) await navigator.clipboard.writeText(text);
        } catch  {}
        this.dispatchEvent(new CustomEvent('md-table-copy', {
            detail: {
                text,
                data
            },
    ...
    _handleDownload = ()=>{
        const data = this._collectData();
        const content = this._toCsv(data);
        const name = `${this.fileName || 'table'}.csv`;
        try {
            const blob = new Blob([
                `\uFEFF${content}`
            ], {
        ...
        this.dispatchEvent(new CustomEvent('md-table-download', {
            detail: {
                fileName: name,
                content,
                data
    ...
    _renderToolbar() {
        if (!this.toolbar) return nothing;
        return external_lit_html`
      <div class="ve-md-table-toolbar" part="toolbar">
        <button
          class="ve-md-table-icon-button"
          part="copy-button"
          type="button"
          aria-label="复制表格"
          title="复制表格"
        ...
        >
          <ve-icon .definition=${copyIcon} size="16"></ve-icon>
        </button>
        <button
          class="ve-md-table-icon-button"
    ...
    render() {
      ...
      ></div>
      <div
        class="ve-md-table-fade ve-md-table-fade--start"
        part="fade-start"
        aria-hidden="true"
      ></div>
      <div
        class="ve-md-table-fade ve-md-table-fade--end"
        part="fade-end"
        aria-hidden="true"
      ></div>
      ${this._renderToolbar()}
...
function ve_markdown_element_toPrimitive(input, hint) {
    if ("object" != typeof input || null === input) return input;
    var prim = input[Symbol.toPrimitive];
    if (void 0 !== prim) {
        var res = prim.call(input, hint || "default");
...
function ve_markdown_element_toPropertyKey(arg) {
    var key = ve_markdown_element_toPrimitive(arg, "string");
    return "symbol" == typeof key ? key : String(key);
}
function ve_markdown_element_checkInRHS(value) {
    if (Object(value) !== value) throw TypeError("right-hand side of 'in' should be an object, got " + (null !== value ? typeof value : "null"));
    return value;
}
function ve_markdown_element_setFunctionName(fn, name, prefix) {
    if ("symbol" == typeof name) {
        name = name.description;
        name = name ? "[" + name + "]" : "";
    }
...
function ve_markdown_element_apply_decs_2311(targetClass, classDecs, memberDecs, classDecsHaveThis, instanceBrand, parentClass) {
    var symbolMetadata = Symbol.metadata || Symbol.for("Symbol.metadata");
    var defineProperty = Object.defineProperty;
    var create = Object.create;
    var metadata;
    ...
    function applyDec(Class, decInfo, decoratorsHaveThis, name, kind, initializers, ret, isStatic, isPrivate, isField, hasPrivateBrand) {
        ...
        if (!isClass) {
            if (isPrivate) {
                if (isField || isAccessor) desc1 = {
                    get: ve_markdown_element_setFunctionName(function() {
                        return decVal(this);
                    }, name, "get"),
                    set: function(value) {
                        decInfo[4](this, value);
                ...
                if (!isField) ve_markdown_element_setFunctionName(desc1[key], name, isMethod ? "" : key);
            } else if (!isField) desc1 = Object.getOwnPropertyDescriptor(Class, name);
            if (!isField && !isPrivate) {
                _ = existingNonFields[+isStatic][name];
                if (_ && (_ ^ kind) !== 7) throw new Error("Decorating two elements with the same name (" + desc1[key].name + ") is not supported yet");
        ...
        var applyMemberDecsOfKind = function(isStatic, isField) {
            for(var i = 0; i < memberDecs.length; i++){
                ...
                if ((8 & kind) == isStatic && !kindOnly == isField) {
                    ...
                    var isPrivate = !!decInfo[3];
                    var decoratorsHaveThis = 16 & kind;
                    applyDec(isStatic ? targetClass : targetClass.prototype, decInfo, decoratorsHaveThis, isPrivate ? "#" + name : ve_markdown_element_toPropertyKey(name), kindOnly, kindOnly < 2 ? [] : isStatic ? staticInitializers = staticInitializers || [] : protoInitializers = protoInitializers || [], ret, !!isStatic, isPrivate, isField, isStatic && isPrivate ? function(_) {
                        return ve_markdown_element_checkInRHS(_) === targetClass;
                    } : instanceBrand);
                }
            }
        };
...
let ve_markdown_element_dec, ve_markdown_element_dec1, ve_markdown_element_dec2, ve_markdown_element_dec3, ve_markdown_element_dec4, ve_markdown_element_dec5, ve_markdown_element_dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _init_content, _init_extra__init_content, _init_size, _init_extra__init_size, _init_wrap, _init_extra__init_wrap, _init_streaming, _init_extra__init_streaming, _init_enableAnimation, _init_extra__init_enableAnimation, _init_openLinksInNewTab, _init_extra__init_openLinksInNewTab, _init_escapeRawHtml, _init_extra__init_escapeRawHtml, _init_protectCustomTagNewlines, _init_extra__init_protectCustomTagNewlines, _init_enableLatex, _init_extra__init_enableLatex, _init_paragraphTag, _init_extra__init_paragraphTag, _init_customTags, _init_extra__init_customTags, _init_hoistCustom, _init_extra__init_hoistCustom, _init_markedConfig, _init_extra__init_markedConfig, _init_dompurifyConfig, _init_extra__init_dompurifyConfig, _init__renderedHtml, _init_extra__init__renderedHtml;
const VE_MARKDOWN_TAG = 've-markdown';
const VE_MARKDOWN_RENDER_EVENT = 've-markdown-render';
const VE_MARKDOWN_STREAM_FLUSH_EVENT = 've-markdown-stream-flush';
ve_markdown_element_dec = property({
    type: String
}), ve_markdown_element_dec1 = property({
    type: String,
    reflect: true
}), ve_markdown_element_dec2 = property({
    type: Boolean,
    reflect: true
}), ve_markdown_element_dec3 = property({
    type: Boolean,
    reflect: true
}), ve_markdown_element_dec4 = property({
    type: Boolean,
    attribute: 'enable-animation',
    reflect: true
}), ve_markdown_element_dec5 = property({
    type: Boolean,
    attribute: 'open-links-in-new-tab',
    reflect: true
}), ve_markdown_element_dec6 = property({
    type: Boolean,
    attribute: 'escape-raw-html',
    reflect: true
}), _dec7 = property({
    type: Boolean,
    attribute: 'protect-custom-tag-newlines',
    reflect: true
}), _dec8 = property({
    type: Boolean,
    attribute: 'enable-latex',
    reflect: true
}), _dec9 = property({
    type: String,
    attribute: 'paragraph-tag',
    reflect: true
}), _dec10 = property({
    attribute: false
}), _dec11 = property({
    type: Boolean,
    attribute: 'hoist-custom-tags',
    reflect: true
}), _dec12 = property({
    attribute: false
}), _dec13 = property({
    attribute: false
}), _dec14 = decorators_js_state();
class VeMarkdownElement extends VeElement {
    static{
        ({ e: [_init_content, _init_extra__init_content, _init_size, _init_extra__init_size, _init_wrap, _init_extra__init_wrap, _init_streaming, _init_extra__init_streaming, _init_enableAnimation, _init_extra__init_enableAnimation, _init_openLinksInNewTab, _init_extra__init_openLinksInNewTab, _init_escapeRawHtml, _init_extra__init_escapeRawHtml, _init_protectCustomTagNewlines, _init_extra__init_protectCustomTagNewlines, _init_enableLatex, _init_extra__init_enableLatex, _init_paragraphTag, _init_extra__init_paragraphTag, _init_customTags, _init_extra__init_customTags, _init_hoistCustom, _init_extra__init_hoistCustom, _init_markedConfig, _init_extra__init_markedConfig, _init_dompurifyConfig, _init_extra__init_dompurifyConfig, _init__renderedHtml, _init_extra__init__renderedHtml] } = ve_markdown_element_apply_decs_2311(this, [], [
            [
                ve_markdown_element_dec,
                1,
                "content"
            ],
            [
                ve_markdown_element_dec1,
                1,
                "size"
            ],
            [
                ve_markdown_element_dec2,
                1,
                "wrap"
            ],
            [
                ve_markdown_element_dec3,
                1,
                "streaming"
            ],
            [
                ve_markdown_element_dec4,
                1,
                "enableAnimation"
            ],
            [
                ve_markdown_element_dec5,
                1,
                "openLinksInNewTab"
            ],
            [
                ve_markdown_element_dec6,
                1,
                "escapeRawHtml"
            ],
            [
    ...
    static styles = ve_markdown;
    static dependencies = {
        [VE_MD_TAIL_TAG]: VeMdTailElement,
        [VE_MD_CODE_BLOCK_TAG]: VeMdCodeBlockElement,
        [VE_MD_TABLE_TAG]: VeMdTableElement
    };
    #___private_content_1 = (()=>{
        const _value = _init_content(this, '');
        _init_extra__init_content(this);
        return _value;
    })();
    get content() {
    ...
    #___private_wrap_3 = (()=>{
        const _value = _init_wrap(this, false);
        _init_extra__init_wrap(this);
        return _value;
    })();
    get wrap() {
        return this.#___private_wrap_3;
    }
    set wrap(_v) {
        this.#___private_wrap_3 = _v;
    }
    #___private_streaming_4 = (()=>{
        const _value = _init_streaming(this, false);
        _init_extra__init_streaming(this);
        return _value;
    })();
    get streaming() {
        return this.#___private_streaming_4;
    }
    set streaming(_v) {
        this.#___private_streaming_4 = _v;
    }
    #___private_enableAnimation_5 = (()=>{
        const _value = _init_enableAnimation(this, false);
        _init_extra__init_enableAnimation(this);
        return _value;
    })();
    get enableAnimation() {
        return this.#___private_enableAnimation_5;
    }
    set enableAnimation(_v) {
        this.#___private_enableAnimation_5 = _v;
    }
    #___private_openLinksInNewTab_6 = (()=>{
        const _value = _init_openLinksInNewTab(this, false);
        _init_extra__init_openLinksInNewTab(this);
        return _value;
    })();
    get openLinksInNewTab() {
        return this.#___private_openLinksInNewTab_6;
    }
    set openLinksInNewTab(_v) {
        this.#___private_openLinksInNewTab_6 = _v;
    }
    #___private_escapeRawHtml_7 = (()=>{
        const _value = _init_escapeRawHtml(this, false);
        _init_extra__init_escapeRawHtml(this);
        return _value;
    })();
    get escapeRawHtml() {
        return this.#___private_escapeRawHtml_7;
    }
    set escapeRawHtml(_v) {
        this.#___private_escapeRawHtml_7 = _v;
    }
    #___private_protectCustomTagNewlines_8 = (()=>{
        const _value = _init_protectCustomTagNewlines(this, false);
        _init_extra__init_protectCustomTagNewlines(this);
        return _value;
    })();
    get protectCustomTagNewlines() {
        return this.#___private_protectCustomTagNewlines_8;
    }
    set protectCustomTagNewlines(_v) {
        this.#___private_protectCustomTagNewlines_8 = _v;
    }
    #___private_enableLatex_9 = (()=>{
        const _value = _init_enableLatex(this, false);
        _init_extra__init_enableLatex(this);
        return _value;
    })();
    get enableLatex() {
        return this.#___private_enableLatex_9;
    }
    set enableLatex(_v) {
        this.#___private_enableLatex_9 = _v;
    }
    #___private_paragraphTag_10 = (()=>{
        const _value = _init_paragraphTag(this, 'p');
        _init_extra__init_paragraphTag(this);
        return _value;
    })();
    get paragraphTag() {
        return this.#___private_paragraphTag_10;
    }
    set paragraphTag(_v) {
        this.#___private_paragraphTag_10 = _v;
    }
    #___private_customTags_11 = (()=>{
        const _value = _init_customTags(this, []);
        _init_extra__init_customTags(this);
        return _value;
    })();
    get customTags() {
        return this.#___private_customTags_11;
    }
    set customTags(_v) {
        this.#___private_customTags_11 = _v;
    }
    #___private_hoistCustom_12 = (()=>{
        const _value = _init_hoistCustom(this, false);
        _init_extra__init_hoistCustom(this);
        return _value;
    })();
    get hoistCustom() {
        return this.#___private_hoistCustom_12;
    }
    set hoistCustom(_v) {
        this.#___private_hoistCustom_12 = _v;
    }
    #___private_markedConfig_13 = (()=>{
        const _value = _init_markedConfig(this, void 0);
        _init_extra__init_markedConfig(this);
        return _value;
    })();
    get markedConfig() {
        return this.#___private_markedConfig_13;
    }
    set markedConfig(_v) {
        this.#___private_markedConfig_13 = _v;
    }
    #___private_dompurifyConfig_14 = (()=>{
        const _value = _init_dompurifyConfig(this, void 0);
        _init_extra__init_dompurifyConfig(this);
        return _value;
    })();
    get dompurifyConfig() {
        return this.#___private_dompurifyConfig_14;
    }
    set dompurifyConfig(_v) {
        this.#___private_dompurifyConfig_14 = _v;
    }
    #___private__renderedHtml_15 = (()=>{
        const _value = _init__renderedHtml(this, '');
        _init_extra__init__renderedHtml(this);
        return _value;
    })();
    get _renderedHtml() {
        return this.#___private__renderedHtml_15;
    }
    set _renderedHtml(_v) {
        this.#___private__renderedHtml_15 = _v;
    }
    _parser;
    _renderer;
    ...
    _customMountSeed = 0;
    _customMountPoints = [];
    _lastHoistedHtml = null;
    _latexExtensions = [];
    connectedCallback() {
        super.connectedCallback();
        if (this.enableLatex) this.setupLatexRuntime();
        this.ensureParser();
        this.ensureRenderer();
    }
    willUpdate(changed) {
        super.willUpdate(changed);
        if (changed.has('enableLatex') && this.enableLatex) this.setupLatexRuntime();
        if (changed.has('paragraphTag') || changed.has('openLinksInNewTab') || changed.has('escapeRawHtml') || changed.has('protectCustomTagNewlines') || changed.has('enableLatex') || changed.has('customTags') || changed.has('markedConfig')) this.ensureParser();
        if (changed.has('customTags') || changed.has('dompurifyConfig')) this.ensureRenderer();
        if (changed.has('content') || changed.has('streaming') || changed.has('paragraphTag') || changed.has('openLinksInNewTab') || changed.has('escapeRawHtml') || changed.has('protectCustomTagNewlines') || changed.has('enableLatex') || changed.has('customTags') || changed.has('markedConfig') || changed.has('dompurifyConfig')) this.recomputeHtml();
    }
    updated(changed) {
        super.updated(changed);
        this.applyHoistCustomTags();
        if (changed.has('content') || changed.has('streaming')) this.dispatchEvent(new CustomEvent(VE_MARKDOWN_RENDER_EVENT, {
            detail: {
    ...
    disconnectedCallback() {
        this._teardownCustomMountPoints();
        this._lastHoistedHtml = null;
        super.disconnectedCallback();
    }
    render() {
        return external_lit_html`<div
      class="ve-markdown"
      part="content"
      @click=${this._handleFootnoteJump}
    >
    ...
    applyHoistCustomTags() {
        ...
        const tags = (this.customTags ?? []).map((tag)=>tag.trim().toLowerCase()).filter(Boolean);
        if (this._lastHoistedHtml === this._renderedHtml && this._customMountPoints.length > 0) return;
        this._teardownCustomMountPoints();
        this._lastHoistedHtml = this._renderedHtml;
        ...
        for (const node of Array.from(matches)){
            ...
            const slotName = `ve-md-custom-${++this._customMountSeed}`;
            const slot = document.createElement('slot');
            slot.name = slotName;
            slot.setAttribute('data-ve-md-custom-slot', tagName);
            node.replaceWith(slot);
            const host = document.createElement('div');
            host.setAttribute('slot', slotName);
            host.setAttribute('data-ve-custom-mount', tagName);
            host.style.display = 'contents';
            for (const attribute of Array.from(node.attributes))host.setAttribute(`data-attr-${attribute.name}`, attribute.value);
            const sourceHtml = node.innerHTML;
            if (sourceHtml) host.setAttribute('data-ve-custom-html', sourceHtml);
            this.appendChild(host);
            this._customMountPoints.push(host);
        }
    }
    _teardownCustomMountPoints() {
        const previousHosts = this._customMountPoints;
        this._customMountPoints = [];
        for (const host of previousHosts)host.remove();
    }
    setupLatexRuntime() {
        if (this._latexExtensions.length) return;
        ensureKatexFontFace(KATEX_FONT_FACE_CSS);
        this.adoptKatexLayoutSheet(KATEX_LAYOUT_CSS);
        this._latexExtensions = createLatexExtensions();
    }
    adoptKatexLayoutSheet(css) {
        const root = this.renderRoot;
        if (!root || !('adoptedStyleSheets' in root)) return;
        const sheet = getKatexLayoutSheet(css);
    ...
    ensureParser() {
        const options = {
            ...
            escapeRawHtml: this.escapeRawHtml,
            protectCustomTagNewlines: this.protectCustomTagNewlines,
            customTags: this.customTags
        };
        if (this.markedConfig) options.markedConfig = this.markedConfig;
        if (this.enableLatex && this._latexExtensions.length) options.latexExtensions = this._latexExtensions;
        const signature = JSON.stringify({
            paragraphTag: options.paragraphTag,
            openLinksInNewTab: options.openLinksInNewTab,
            escapeRawHtml: options.escapeRawHtml,
            protectCustomTagNewlines: options.protectCustomTagNewlines,
            customTags: options.customTags,
            hasMarkedConfig: Boolean(options.markedConfig),
            hasLatex: Boolean(options.latexExtensions)
        });
        if (this._parser && signature === this._parserSignature && !this.markedConfig) return;
        this._parser = new Parser(options);
        this._parserSignature = signature;
    }
    ensureRenderer() {
        const options = {
            customTags: this.customTags
        };
        if (this.dompurifyConfig) options.dompurifyConfig = this.dompurifyConfig;
        const signature = JSON.stringify({
            customTags: options.customTags,
            hasDompurifyConfig: Boolean(options.dompurifyConfig)
        });
        if (this._renderer && signature === this._rendererSignature && !this.dompurifyConfig) return;
        this._renderer = new Renderer(options);
        this._rendererSignature = signature;
    }
    recomputeHtml() {
        const previousPending = this._streamingBuffer.pending;
        this._streamingBuffer.push(this.content ?? '', this.streaming);
        const merged = this._streamingBuffer.committedMarkdown + this._streamingBuffer.pending;
        const html = this._parser.parse(merged, {
            injectTail: this.streaming
        });
        const safeHtml = this._renderer.sanitize(html);
        this._renderedHtml = safeHtml;
        if (previousPending && !this.streaming) this.dispatchEvent(new CustomEvent(VE_MARKDOWN_STREAM_FLUSH_EVENT, {
            detail: {
...
defineCustomElement(VE_MARKDOWN_TAG, VeMarkdownElement);
export { VE_MARKDOWN_RENDER_EVENT, VE_MARKDOWN_STREAM_FLUSH_EVENT, VE_MARKDOWN_TAG, VeMarkdownElement };
