...
import { n as f, t as p } from "./style-map-G3HmCkCW.mjs";
import { t as m } from "./close-BGLOLIw1.mjs";
...
}), N = d(".ve-input-control"), P = d(".ve-input-mirror"), te = d("slot[name=\"prefix\"]"), ne = d("slot[name=\"suffix\"]"), re = r(), F = r();
var Pe = class extends s {
	...
	renderClearButton() {
		return this.shouldShowClearButton ? i`
      <button
        class=${f({
			"ve-input-clear": !0,
	...
	renderPrefix() {
		return this.hasPrefixContent ? i`
	...
	renderSuffix() {
		return this.shouldShowWordLimitInInput ? i`
        <span
          class=${f({
			"ve-input-suffix": !0,
	...
	render() {
        ...
        >
          ...
          ${this.shouldShowWordLimitInsideTextarea ? i`
                <span
                  class=${f({
			...
			"ve-textarea-word-limit--error": this.hasLengthError
              ...
              ` : a}
          ${this.shouldShowWordLimitOutsideTextarea ? i`
                <span
                  class=${f({
			"ve-textarea-word-limit": !0,
      ...
      >
        ...
        ${this.resolvedAutoWidthConfig === null ? a : i`<span class="ve-input-mirror" aria-hidden="true"></span>`}
      </div>
    `;
	}
};
