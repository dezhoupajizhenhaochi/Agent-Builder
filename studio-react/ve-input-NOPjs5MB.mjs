import { _ as e, a as t, c as n, h as r, l as i, m as a, n as o, p as s, r as c, s as l, v as u } from "./20787-Dhb05CfP.mjs";
import { t as d } from "./query-BYu9q8lA.mjs";
import { n as f, t as p } from "./style-map-5Oq92Mj5.mjs";
import { t as m } from "./close-D8GzkOJu.mjs";
...
var Pe = class extends l {
	...
	renderClearButton() {
		return this.shouldShowClearButton ? e`
      <button
        class=${f({
			"ve-input-clear": !0,
        ...
        part="clear"
        type="button"
        tabindex=${t(this.disabled ? "-1" : void 0)}
        aria-label=${Oe}
	...
	renderPrefix() {
		return this.hasPrefixContent ? e`
	...
	renderSuffix() {
		return this.shouldShowWordLimitInInput ? e`
        <span
          class=${f({
			"ve-input-suffix": !0,
	...
	renderControl() {
        ...
        <textarea
          ...
          placeholder=${t(this.placeholder || void 0)}
          maxlength=${t(this.nativeMaxLength)}
          ...
          aria-invalid=${t(this.nativeAriaInvalid)}
	...
	render() {
        ...
        >
          ...
          ${this.shouldShowWordLimitInsideTextarea ? e`
                <span
                  class=${f({
			...
			"ve-textarea-word-limit--error": this.hasLengthError
              ...
              ` : r}
          ${this.shouldShowWordLimitOutsideTextarea ? e`
                <span
                  class=${f({
			"ve-textarea-word-limit": !0,
      ...
      >
        ...
        ${this.resolvedAutoWidthConfig === null ? r : e`<span class="ve-input-mirror" aria-hidden="true"></span>`}
      </div>
    `;
	}
};
