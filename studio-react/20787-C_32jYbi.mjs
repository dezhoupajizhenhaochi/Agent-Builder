...
import { i as s, r as c } from "./23467-B8vj8biU.mjs";
//#region node_modules/@ve-design/web/dist/78928.js
...
var N = class extends l {
	...
	connectedCallback() {
		super.connectedCallback(), this.removeIconRegistryChangeListener = c((e) => {
	...
	loadCurrentIcon() {
		...
		!e || s(e) || import("./23467-B8vj8biU.mjs").then((e) => e.t).then((e) => e.loader_namespaceObject).then(({ isBuiltInIconName: t, loadIcon: n }) => {
			if (!((this.name ?? "").trim() !== e || s(e) || !t(e))) return n(e);
		}).catch(() => {});
	}
	get resolvedIcon() {
		return this.definition ? this.definition : this.name ? s(this.name) : void 0;
	}
	get normalizedSize() {
