...
var V = (e, t) => {
	...
	for (let t = 0; t < n; t++) {
		...
		for (; u < n.length && (o.lastIndex = u, c = o.exec(n), c !== null);) u = o.lastIndex, o === j ? c[1] === "!--" ? o = se : c[1] === void 0 ? c[2] === void 0 ? c[3] !== void 0 && (o = N) : (F.test(c[2]) && (i = RegExp("</" + c[2], "g")), o = N) : o = M : o === N ? c[0] === ">" ? (o = i ?? j, l = -1) : c[1] === void 0 ? l = -2 : (l = o.lastIndex - c[2].length, s = c[1], o = c[3] === void 0 ? N : c[3] === "\"" ? P : ce) : o === P || o === ce ? o = N : o === se || o === M ? o = j : (o = N, i = void 0);
...
var W = class {
	...
	u(e) {
		...
		for (; s !== void 0;) {
			if (a === s.index) {
				let t;
				s.type === 2 ? t = new G(i, i.nextSibling, this, e) : s.type === 1 ? t = new s.ctor(i, s.name, s.strings, this, e) : s.type === 6 && (t = new de(i, this, e)), this._$AV.push(t), s = n[++o];
			}
	...
	_$AI(e, t = this) {
		e = U(this, e, t), D(e) ? e === L || e == null || e === "" ? (this._$AH !== L && this._$AR(), this._$AH = L) : e !== this._$AH && e !== I && this._(e) : e._$litType$ === void 0 ? e.nodeType === void 0 ? k(e) ? this.k(e) : this._(e) : this.T(e) : this.$(e);
	}
	O(e) {
	...
	_$AI(e, t = this, n, r) {
		...
		if (i === void 0) e = U(this, e, t, 0), a = !D(e) || e !== this._$AH && e !== I, a && (this._$AH = e);
		else {
			let r = e, o, s;
			for (e = i[0], o = 0; o < i.length - 1; o++) s = U(this, r[n + o], t, o), s === I && (s = this._$AH[o]), a ||= !D(s) || s !== this._$AH[o], s === L ? e = L : e !== L && (e += (s ?? "") + i[o + 1]), this._$AH[o] = s;
		}
		a && !r && this.j(e);
	}
	j(e) {
...
pe?.(H, G), (y.litHtmlVersions ??= []).push("3.3.3");
var me = (e, t, n) => {
...
var he = Y.litElementPolyfillSupport;
he?.({ LitElement: X }), (Y.litElementVersions ??= []).push("4.2.2");
//#endregion
...
var be = {
	...
	constructor(e) {
		if (super(e), this.it = L, e.type !== be.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
	}
	render(e) {
...
var Se = Z(Q), Ce = (e) => e ?? L, $ = class extends Q {};
$.directiveName = "unsafeSVG", $.resultType = 2;
var we = Z($);
//#endregion
export { xe as a, ve as c, me as d, I as f, o as h, Z as i, X as l, fe as m, Ce as n, be as o, le as p, Se as r, ye as s, we as t, L as u };
