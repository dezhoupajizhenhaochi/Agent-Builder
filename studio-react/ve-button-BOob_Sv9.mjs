...
import { n as f } from "./42938-J_Bs_E05.mjs";
...
v = c({
	...
	type: Boolean,
	reflect: !0
}), T = c({ type: String }), E = c({ type: String }), D = d(".ve-btn"), O = d(".ve-btn-content"), k = d("slot"), A = n();
var se = class extends s {
	...
	render() {
		...
		return this.isLinkMode ? r`
        <a
          class=${e}
          part="control"
          href=${i(this.isUnavailable ? void 0 : this.href)}
          target=${i(this.isUnavailable ? void 0 : this.target)}
          rel=${i(!this.isUnavailable && this.target === "_blank" ? "noreferrer noopener" : void 0)}
          ...
          aria-disabled=${i(this.isUnavailable ? "true" : void 0)}
          aria-busy=${i(this.loading ? "true" : void 0)}
          tabindex=${i(this.isUnavailable ? "-1" : void 0)}
