import { i as e, r as t } from "./23467-C3MSgesJ.mjs";
...
}, he = E.litHtmlPolyfillSupport;
he?.(W, K), (E.litHtmlVersions ??= []).push("3.3.3");
var ge = (e, t, n) => {
...
`, Q = class extends Ce {
	constructor(e) {
		if (super(e), this.it = H, e.type !== xe.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
	}
	render(e) {
...
function Fe(e, t, n, r, i, a) {
	...
	function h(e, t, n, r, i, a, o, c, d, h, g) {
		...
		} : E[O] = y, h || Pe(E[O], r, w ? "" : O)) : h || (E = Object.getOwnPropertyDescriptor(e, r)), !h && !d)) {
		...
		var t = [], r, a, o = function(e) {
			...
			for (var c = 0; c < n.length; c++) {
				...
				if ((8 & u) == o && !d == s) {
					...
					h(o ? e : e.prototype, l, m, p ? "#" + f : Me(f), d, d < 2 ? [] : o ? a ||= [] : r ||= [], t, !!o, p, s, o && p ? function(t) {
						return Ne(t) === e;
					} : i);
				}
			}
...
var Ie, Le, Re, ze, Be, Ve, He, Ue, We, Ge, Ke, qe, Je = "ve-icon";
Ie = X({
	type: String,
	reflect: !0
}), Le = X({ attribute: !1 }), Re = X({ type: String }), ze = X({ reflect: !0 });
var Ye = class extends we {
	static {
		({e: [Be, Ve, He, Ue, We, Ge, Ke, qe]} = Fe(this, [], [
			[
				Ie,
				1,
				"name"
	...
	loadCurrentIcon() {
		...
		!t || e(t) || import("./23467-C3MSgesJ.mjs").then((e) => e.t).then((e) => e.loader_namespaceObject).then(({ isBuiltInIconName: n, loadIcon: r }) => {
	...
	render() {
      ...
      <span
        class="ve-icon"
        part="icon"
        style=${Z(this.iconStyle)}
        role=${Z(t ? "img" : void 0)}
        aria-label=${Z(t || void 0)}
        aria-hidden=${Z(t ? void 0 : "true")}
      >
        ${ke(e.svg)}
      </span>
    `;
...
Xe();
//#endregion
export { Oe as a, Se as c, be as d, X as f, c as g, oe as h, we as i, Ce as l, V as m, Je as n, De as o, H as p, Ye as r, Z as s, Xe as t, xe as u };
