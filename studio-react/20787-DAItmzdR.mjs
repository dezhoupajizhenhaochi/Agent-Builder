import { i as e, r as t } from "./23467-BjeV2xCg.mjs";
...
var Xe = class extends we {
	...
	loadCurrentIcon() {
		...
		!t || e(t) || import("./23467-BjeV2xCg.mjs").then((e) => e.t).then((e) => e.loader_namespaceObject).then(({ isBuiltInIconName: n, loadIcon: r }) => {
...
Ze();
//#endregion
export { c as _, Z as a, De as c, Se as d, xe as f, se as g, B as h, ke as i, X as l, V as m, Ye as n, we as o, Y as p, Xe as r, Oe as s, Ze as t, Ce as u };
