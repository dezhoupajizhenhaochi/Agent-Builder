import { i as e, r as t } from "./23467-EcngkUU8.mjs";
...
var Ye = class extends we {
	...
	loadCurrentIcon() {
		...
		!t || e(t) || import("./23467-EcngkUU8.mjs").then((e) => e.t).then((e) => e.loader_namespaceObject).then(({ isBuiltInIconName: n, loadIcon: r }) => {
...
Xe();
//#endregion
export { we as a, Se as c, be as d, X as f, c as g, oe as h, Z as i, Ce as l, V as m, Je as n, Oe as o, H as p, Ye as r, De as s, Xe as t, xe as u };
