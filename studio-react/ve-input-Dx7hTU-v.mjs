import { c as e, h as t, n, p as r, s as i, u as a } from "./unsafe-svg-BFm0oi37.mjs";
import { t as o } from "./query-BYu9q8lA.mjs";
import { n as s, t as c } from "./style-map-HTyDAfpK.mjs";
import { a as l, i as u, n as d, o as f, r as p } from "./20787-Od_gWUQY.mjs";
import { t as m } from "./close-CPqhf02g.mjs";
//#region node_modules/@ve-design/react/node_modules/@ve-design/web/dist/ve-input.js
var h = [
	l,
	t`
  :host {
...
}), N = o(".ve-input-control"), P = o(".ve-input-mirror"), te = o("slot[name=\"prefix\"]"), ne = o("slot[name=\"suffix\"]"), re = i(), F = i();
var Pe = class extends u {
	...
	renderControl() {
        ...
        <textarea
          ...
          style=${c(this.getTextareaStyles())}
          placeholder=${n(this.placeholder || void 0)}
          maxlength=${n(this.nativeMaxLength)}
          aria-label=${n(this.controlAriaLabel)}
          aria-labelledby=${n(this.controlAriaLabelledby)}
          aria-describedby=${n(this.controlAriaDescribedby)}
          aria-invalid=${n(this.nativeAriaInvalid)}
	...
	render() {
        ...
        <div
          ...
          style=${c(this.getInputWrapperStyles())}
          part="wrapper"
