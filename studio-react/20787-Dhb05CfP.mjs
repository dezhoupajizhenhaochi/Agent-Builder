import { a as e, o as t } from "./23467-xLG5Nc5B.mjs";
...
var Xe = class extends we {
	...
	loadCurrentIcon() {
		...
		!e || t(e) || import("./23467-xLG5Nc5B.mjs").then((e) => e.t).then((e) => e.loader_namespaceObject).then(({ isBuiltInIconName: n, loadIcon: r }) => {
...
Ze();
//#endregion
export { se as _, Q as a, Oe as c, Ce as d, Se as f, B as g, V as h, Ae as i, De as l, Y as m, Ye as n, ke as o, xe as p, Xe as r, we as s, Ze as t, X as u, c as v };
