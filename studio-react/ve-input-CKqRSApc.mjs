import { a as e, b as t, c as n, h as r, l as i, m as a, n as o, p as s, r as c, s as l, v as u } from "./20787-CMh5wxFf.mjs";
import { t as d } from "./query-BYu9q8lA.mjs";
import { n as f, t as p } from "./style-map-CzvdUTQ7.mjs";
import { t as m } from "./close-SPk98HCC.mjs";
...
}), N = d(".ve-input-control"), P = d(".ve-input-mirror"), te = d("slot[name=\"prefix\"]"), ne = d("slot[name=\"suffix\"]"), re = s(), F = s();
var Pe = class extends l {
	...
	renderClearButton() {
		return this.shouldShowClearButton ? u`
      <button
        class=${f({
			"ve-input-clear": !0,
        ...
        part="clear"
        type="button"
        tabindex=${e(this.disabled ? "-1" : void 0)}
        aria-label=${Oe}
	...
	renderPrefix() {
		return this.hasPrefixContent ? u`
	...
	renderSuffix() {
		return this.shouldShowWordLimitInInput ? u`
        <span
          class=${f({
			"ve-input-suffix": !0,
	...
	renderControl() {
        ...
        <textarea
          ...
          placeholder=${e(this.placeholder || void 0)}
          maxlength=${e(this.nativeMaxLength)}
          aria-label=${e(this.controlAriaLabel)}
          aria-labelledby=${e(this.controlAriaLabelledby)}
          aria-describedby=${e(this.controlAriaDescribedby)}
          aria-invalid=${e(this.nativeAriaInvalid)}
	...
	render() {
        ...
        >
          ...
          ${this.shouldShowWordLimitInsideTextarea ? u`
                <span
                  class=${f({
			...
			"ve-textarea-word-limit--error": this.hasLengthError
              ...
              ` : r}
          ${this.shouldShowWordLimitOutsideTextarea ? u`
                <span
                  class=${f({
			"ve-textarea-word-limit": !0,
      ...
      >
        ...
        ${this.resolvedAutoWidthConfig === null ? r : u`<span class="ve-input-mirror" aria-hidden="true"></span>`}
      </div>
    `;
	}
};
